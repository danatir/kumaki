...
vocabData['S1'] = {
  'GEN': [
    {word:'寿司',reading:'すし',def:'sushi',pos:'Noun',sub:'Day1'},
    {word:'鍵',reading:'かぎ',def:'key',pos:'Noun',sub:'Day1'},
    {word:'傘',reading:'かさ',def:'umbrella',pos:'Noun',sub:'Day1'},
    {word:'駅',reading:'えき',def:'station',pos:'Noun',sub:'Day1'},
    {word:'椅子',reading:'いす',def:'chair',pos:'Noun',sub:'Day1'},
    {word:'木',reading:'き',def:'tree',pos:'Noun',sub:'Day1'},
    {word:'塩',reading:'しお',def:'salt',pos:'Noun',sub:'Day1'},
    {word:'牛',reading:'うし',def:'cow, cattle',pos:'Noun',sub:'Day1'},
    {word:'手',reading:'て',def:'hand',pos:'Noun',sub:'Day2'},
    {word:'お金',reading:'おかね',def:'money',pos:'Noun',sub:'Day2'},
    {word:'くつ',reading:'',def:'shoes',pos:'Noun',sub:'Day2'},
    {word:'机',reading:'つくえ',def:'desk',pos:'Noun',sub:'Day2'},
    {word:'魚',reading:'さかな',def:'fish',pos:'Noun',sub:'Day2'},
    {word:'肉',reading:'にく',def:'meat',pos:'Noun',sub:'Day2'},
    {word:'猫',reading:'ねこ',def:'cat',pos:'Noun',sub:'Day2'},
    {word:'たばこ',reading:'',def:'cigarette, tobacco',pos:'Noun',sub:'Day2'},
    {word:'犬',reading:'いぬ',def:'dog',pos:'Noun',sub:'Day2'},
    {word:'りんご',reading:'',def:'apple',pos:'Noun',sub:'Day3'},
    {word:'眼鏡',reading:'めがね',def:'glasses',pos:'Noun',sub:'Day3'},
    {word:'電話',reading:'でんわ',def:'telephone',pos:'Noun',sub:'Day3'},
    {word:'鉛筆',reading:'えんぴつ',def:'pencil',pos:'Noun',sub:'Day3'},
    {word:'私',reading:'わたし',def:'I, me',pos:'Noun',sub:'Day3'},
    {word:'車',reading:'くるま',def:'car',pos:'Noun',sub:'Day3'},
    {word:'本',reading:'ほん',def:'book',pos:'Noun',sub:'Day3'},
    {word:'果物',reading:'くだもの',def:'fruit',pos:'Noun',sub:'Day3'},
    {word:'新聞',reading:'しんぶん',def:'newspaper',pos:'Noun',sub:'Day3'},
    {word:'鞄',reading:'かばん',def:'bag',pos:'Noun',sub:'Day3'},
    {word:'切手',reading:'きって',def:'stamp',pos:'Noun',sub:'Day3'},
    {word:'切符',reading:'きっぷ',def:'ticket',pos:'Noun',sub:'Day3'},
    {word:'雑誌',reading:'ざっし',def:'magazine',pos:'Noun',sub:'Day3'},
    {word:'学生',reading:'がくせい',def:'student',pos:'Noun',sub:'Day4'},
    {word:'先生',reading:'せんせい',def:'teacher',pos:'Noun',sub:'Day4'},
    {word:'時計',reading:'とけい',def:'watch, clock',pos:'Noun',sub:'Day4'},
    {word:'帽子',reading:'ぼうし',def:'hat, cap',pos:'Noun',sub:'Day4'},
    {word:'銀行',reading:'ぎんこう',def:'bank',pos:'Noun',sub:'Day4'},
    {word:'辞書',reading:'じしょ',def:'dictionary',pos:'Noun',sub:'Day4'},
    {word:'電車',reading:'でんしゃ',def:'train',pos:'Noun',sub:'Day4'},
    {word:'宿題',reading:'しゅくだい',def:'homework',pos:'Noun',sub:'Day4'},
    {word:'今日',reading:'きょう',def:'today',pos:'Noun',sub:'Day5'},
    {word:'教室',reading:'きょうしつ',def:'classroom',pos:'Noun',sub:'Day5'},
    {word:'教科書',reading:'きょうかしょ',def:'textbook',pos:'Noun',sub:'Day5'},
    {word:'郵便局',reading:'ゆうびんきょく',def:'post office',pos:'Noun',sub:'Day5'},
    {word:'病院',reading:'びょういん',def:'hospital',pos:'Noun',sub:'Day5'},
    {word:'月曜日',reading:'げつようび',def:'Monday',pos:'Noun',sub:'Day5'},
    {word:'火曜日',reading:'かようび',def:'Tuesday',pos:'Noun',sub:'Day5'},
    {word:'水曜日',reading:'すいようび',def:'Wednesday',pos:'Noun',sub:'Day5'},
    {word:'木曜日',reading:'もくようび',def:'Thursday',pos:'Noun',sub:'Day5'},
    {word:'金曜日',reading:'きんようび',def:'Friday',pos:'Noun',sub:'Day5'},
    {word:'土曜日',reading:'どようび',def:'Saturday',pos:'Noun',sub:'Day5'},
    {word:'日曜日',reading:'にちようび',def:'Sunday',pos:'Noun',sub:'Day5'},
  ],
  'L1': [
    {word:'私',reading:'わたし',def:'I, me',pos:'Noun',sub:'1-2'},
    {word:'あなた',reading:'',def:'you',pos:'Noun',sub:'1-2'},
    ...
    {word:'イギリス',reading:'',def:'UK, England',pos:'Noun',sub:'1-2'},
    {word:'フランス',reading:'',def:'France',pos:'Noun',sub:'1-2'},
    {word:'アメリカ',reading:'',def:'USA',pos:'Noun',sub:'1-2'},
    ...
    {word:'ドイツ',reading:'',def:'Germany',pos:'Noun',sub:'1-2'},
  ],
  'L2': [
    ...
    {word:'いす',reading:'',def:'chair',pos:'Noun',sub:'2-2'},
    ...
    {word:'ペン',reading:'',def:'pen',pos:'Noun',sub:'2-2'},
    {word:'えんぴつ',reading:'',def:'pencil',pos:'Noun',sub:'2-2'},
    {word:'かばん',reading:'',def:'bag',pos:'Noun',sub:'2-2'},
    {word:'くつ',reading:'',def:'shoes',pos:'Noun',sub:'2-2'},
    {word:'りんご',reading:'',def:'apple',pos:'Noun',sub:'2-2'},
    {word:'電話',reading:'でんわ',def:'telephone',pos:'Noun',sub:'2-2'},
    {word:'新聞',reading:'しんぶん',def:'newspaper',pos:'Noun',sub:'2-2'},
    {word:'パイナップル',reading:'',def:'pineapple',pos:'Noun',sub:'2-3'},
    {word:'みかん',reading:'',def:'mandarin orange',pos:'Noun',sub:'2-3'},
    {word:'バナナ',reading:'',def:'banana',pos:'Noun',sub:'2-3'},
    {word:'切符',reading:'きっぷ',def:'ticket',pos:'Noun',sub:'2-3'},
    {word:'テレビ',reading:'',def:'television',pos:'Noun',sub:'2-3'},
    {word:'パン',reading:'',def:'bread',pos:'Noun',sub:'2-3'},
    {word:'ノート',reading:'',def:'notebook',pos:'Noun',sub:'2-3'},
    {word:'車',reading:'くるま',def:'car',pos:'Noun',sub:'2-3'},
    {word:'指輪',reading:'ゆびわ',def:'ring',pos:'Noun',sub:'2-4'},
    {word:'シャツ',reading:'',def:'shirt',pos:'Noun',sub:'2-4'},
    {word:'服',reading:'ふく',def:'clothes',pos:'Noun',sub:'2-4'},
    {word:'眼鏡',reading:'めがね',def:'glasses',pos:'Noun',sub:'2-4'},
    {word:'パソコン',reading:'',def:'computer',pos:'Noun',sub:'2-5'},
    {word:'スイス',reading:'',def:'Switzerland',pos:'Noun',sub:'2-5'},
    {word:'イタリア',reading:'',def:'Italy',pos:'Noun',sub:'2-5'},
    {word:'カメラ',reading:'',def:'camera',pos:'Noun',sub:'2-5'},
    {word:'（お）酒',reading:'（お）さけ',def:'alcohol, sake',pos:'Noun',sub:'2-5'},
    {word:'カップ',reading:'',def:'cup',pos:'Noun',sub:'2-5'},
  ],
  'L3': [
    {word:'アパート',reading:'',def:'apartment',pos:'Noun',sub:'3-1'},
    {word:'うち',reading:'',def:'home, house',pos:'Noun',sub:'3-2'},
    {word:'テスト',reading:'',def:'test, exam',pos:'Noun',sub:'3-2'},
    {word:'髪',reading:'かみ',def:'hair',pos:'Noun',sub:'3-2'},
    {word:'ケーキ',reading:'',def:'cake',pos:'Noun',sub:'3-2'},
    {word:'木',reading:'き',def:'tree',pos:'Noun',sub:'3-2'},
    {word:'部屋',reading:'へや',def:'room',pos:'Noun',sub:'3-2'},
    {word:'大きい',reading:'おおきい',def:'big, large',pos:'Adj',adj:'i',sub:'3-2',ex:'山田さんの車は大きいです。'},
    {word:'小さい',reading:'ちいさい',def:'small, little',pos:'Adj',adj:'i',sub:'3-2',ex:'このねこは小さいです。'},
    {word:'高い',reading:'たかい',def:'tall, expensive',pos:'Adj',adj:'i',sub:'3-2',ex:'めがねはたかいです。'},
    {word:'安い',reading:'やすい',def:'cheap',pos:'Adj',adj:'i',sub:'3-2',ex:'きってはやすいです。'},
    {word:'低い',reading:'ひくい',def:'low; short (height)',pos:'Adj',adj:'i',sub:'3-2',ex:'あの木はひくいです。'},
    {word:'長い',reading:'ながい',def:'long',pos:'Adj',adj:'i',sub:'3-2',ex:'わたしのかみはながいです。'},
    {word:'短い',reading:'みじかい',def:'short (length)',pos:'Adj',adj:'i',sub:'3-2',ex:'かれのかみはみじかいです。'},
    {word:'新しい',reading:'あたらしい',def:'new',pos:'Adj',adj:'i',sub:'3-2',ex:'このカメラはあたらしいです。'},
    {word:'古い',reading:'ふるい',def:'old (thing)',pos:'Adj',adj:'i',sub:'3-2',ex:'この本はふるいです。'},
    {word:'おいしい',reading:'',def:'delicious',pos:'Adj',adj:'i',sub:'3-2',ex:'このりんごはおいしいです。'},
    {word:'まずい',reading:'',def:'bad tasting',pos:'Adj',adj:'i',sub:'3-2',ex:'そのおさけはまずいです。'},
    {word:'難しい',reading:'むずかしい',def:'difficult',pos:'Adj',adj:'i',sub:'3-2',ex:'このテストはむずかしいです。'},
    {word:'易しい',reading:'やさしい',def:'easy',pos:'Adj',adj:'i',sub:'3-2',ex:'この本はやさしいです。'},
    {word:'暑い',reading:'あつい',def:'hot (weather)',pos:'Adj',adj:'i',sub:'3-2',ex:'今日はあついです。'},
    {word:'寒い',reading:'さむい',def:'cold (weather)',pos:'Adj',adj:'i',sub:'3-2',ex:'このへやはさむいです。'},
    {word:'いい',reading:'',def:'good',pos:'Adj',adj:'i',sub:'3-2',ex:'そのじしょはいいです。'},
    {word:'悪い',reading:'わるい',def:'bad; wrong',pos:'Adj',adj:'i',sub:'3-2',ex:'そのじしょはわるいです。'},
    {word:'面白い',reading:'おもしろい',def:'interesting; funny',pos:'Adj',adj:'i',sub:'3-2',ex:'このテレビはおもしろいです。'},
    {word:'つまらない',reading:'',def:'boring',pos:'Adj',adj:'i',sub:'3-2',ex:'この本はつまらないです。'},
    {word:'重い',reading:'おもい',def:'heavy',pos:'Adj',adj:'i',sub:'3-2',ex:'このつくえはおもいです。'},
    {word:'軽い',reading:'かるい',def:'light (weight)',pos:'Adj',adj:'i',sub:'3-2',ex:'このいすはかるいです。'},
    {word:'白い',reading:'しろい',def:'white',pos:'Adj',adj:'i',sub:'3-2',ex:'あのとりはしろいです。'},
    {word:'黒い',reading:'くろい',def:'black',pos:'Adj',adj:'i',sub:'3-2',ex:'このねこはくろいです。'},
    {word:'うるさい',reading:'',def:'noisy, loud',pos:'Adj',adj:'i',sub:'3-2',ex:'大きい犬はうるさいです。'},
    {word:'忙しい',reading:'いそがしい',def:'busy',pos:'Adj',adj:'i',sub:'3-2',ex:'このアルバイトはとてもいそがしいです。'},
    {word:'汚い',reading:'きたない',def:'dirty; messy',pos:'Adj',adj:'i',sub:'3-2',ex:'彼のへやはきたないです。'},
    ...
    {word:'とても',reading:'',def:'very',pos:'Adv',sub:'3-3',ex:'わたしのかばんはとても大きいです。'},
    {word:'親切',reading:'しんせつ',def:'kind, friendly',pos:'Adj',adj:'na',sub:'3-3',ex:'彼はしんせつです。'},
    {word:'便利',reading:'べんり',def:'convenient; useful',pos:'Adj',adj:'na',sub:'3-3',ex:'コンピューターはべんりです。'},
    {word:'きれい',reading:'',def:'pretty, clean',pos:'Adj',adj:'na',sub:'3-3',ex:'彼女はきれいです。'},
    {word:'静か',reading:'しずか',def:'quiet; calm',pos:'Adj',adj:'na',sub:'3-3',ex:'まちはしずかです。'},
    {word:'元気',reading:'げんき',def:'healthy, energetic',pos:'Adj',adj:'na',sub:'3-3',ex:'彼はげんきです。'},
    {word:'大切',reading:'たいせつ',def:'important',pos:'Adj',adj:'na',sub:'3-3',ex:'じしょはたいせつです。'},
    {word:'ハンサム',reading:'',def:'handsome',pos:'Adj',adj:'na',sub:'3-3',ex:'アンドリューさんはハンサムです。'},
    {word:'暇',reading:'ひま',def:'free time; not busy',pos:'Adj',adj:'na',sub:'3-3',ex:'私はあしたひまです。'},
    {word:'大変',reading:'たいへん',def:'tough; hard; terrible',pos:'Adj',adj:'na',sub:'3-3'},
    {word:'人',reading:'ひと',def:'person',pos:'Noun',sub:'3-4'},
    {word:'クラスメート',reading:'',def:'classmate',pos:'Noun',sub:'3-4'},
    ...
    {word:'近い',reading:'ちかい',def:'near; close',pos:'Adj',adj:'i',sub:'3·Reading',ex:'家はとても近いです。'},
    {word:'でも',reading:'',def:'but, however',pos:'Conj',sub:'3·Reading',ex:'私のかばんはちいさいです。 でも、おもいです。'},
  ],
  'L4': [
    {word:'スケジュール',reading:'',def:'schedule',pos:'Noun',sub:'4-1'},
    ...
    {word:'クラス',reading:'',def:'class',pos:'Noun',sub:'4-2'},
    {word:'郵便局',reading:'ゆうびんきょく',def:'post office',pos:'Noun',sub:'4-2'},
    {word:'レストラン',reading:'',def:'restaurant',pos:'Noun',sub:'4-2'},
    {word:'コンサート',reading:'',def:'concert',pos:'Noun',sub:'4-2'},
    {word:'デパート',reading:'',def:'department store',pos:'Noun',sub:'4-2'},
    {word:'映画',reading:'えいが',def:'movie, film',pos:'Noun',sub:'4-2'},
    {word:'学校',reading:'がっこう',def:'school',pos:'Noun',sub:'4-3'},
    {word:'ソウル',reading:'',def:'Seoul',pos:'Noun',sub:'4-3'},
    {word:'コンビニ',reading:'',def:'convenience store',pos:'Noun',sub:'4-3'},
    {word:'カフェ',reading:'',def:'café',pos:'Noun',sub:'4-3'},
    ...
    {word:'パーティ',reading:'',def:'party',pos:'Noun',sub:'4-4'},
    {word:'休み',reading:'やすみ',def:'holiday, day off',pos:'Noun',sub:'4-4'},
    {word:'デート',reading:'',def:'date',pos:'Noun',sub:'4-4'},
    ...
    {word:'ピクニック',reading:'',def:'picnic',pos:'Noun',sub:'4-5'},
    {word:'ゴールデンウィーク',reading:'',def:'Golden Week',pos:'Noun',sub:'4-5'},
  ],
  'L5': [
    {word:'毎日',reading:'まいにち',def:'every day',pos:'Noun',sub:'5-1'},
    {word:'コーヒー',reading:'',def:'coffee',pos:'Noun',sub:'5-1'},
    {word:'英語',reading:'えいご',def:'English (language)',pos:'Noun',sub:'5-1'},
    {word:'ビデオ',reading:'',def:'video',pos:'Noun',sub:'5-1'},
    {word:'てんぷら',reading:'',def:'tempura',pos:'Noun',sub:'5-1'},
    ...
    {word:'たばこ',reading:'',def:'cigarette, tobacco',pos:'Noun',sub:'5-1'},
    {word:'スパゲティ',reading:'',def:'spaghetti',pos:'Noun',sub:'5-1'},
    ...
    {word:'します',reading:'',def:'to do',pos:'Verb',grp:'G3',sub:'5-1',ex:'こうえんでピクニックをします。'},
    {word:'勉強をします',reading:'べんきょうをします',def:'to study',pos:'Verb',grp:'G3',sub:'5-1',ex:'毎日、勉強をします。'},
    {word:'テニスをします',reading:'',def:'to play tennis',pos:'Verb',grp:'G3',sub:'5-1',ex:'日曜日にテニスをします。'},
    ...
    {word:'サッカー',reading:'',def:'soccer',pos:'Noun',sub:'5-2'},
    ...
    {word:'ステーキ',reading:'',def:'steak',pos:'Noun',sub:'5-2'},
    ...
    {word:'スキー',reading:'',def:'skiing',pos:'Noun',sub:'5-3'},
    ...
    {word:'ときどき',reading:'',def:'sometimes',pos:'Adv',sub:'5-3',ex:'中野さんはときどきとしょかんへ行きます。'},
    ...
    {word:'それから',reading:'',def:'and then, after that',pos:'Conj',sub:'5-4',ex:'彼女はひるごはんを食べます。 それから、こうえんへ行きます。'},
    ...
    {word:'スポーツ',reading:'',def:'sports',pos:'Noun',sub:'5-5'},
    {word:'よく',reading:'',def:'often, well',pos:'Adv',sub:'5-5',ex:'よく映画を見ますか。'},
    {word:'あまり',reading:'',def:'not very (+ negative)',pos:'Adv',sub:'5-5',ex:'私はあまり旅行をしません。'},
    {word:'全然',reading:'ぜんぜん',def:'not at all (+ negative)',pos:'Adv',sub:'5-5',ex:'私はぜんぜんそうじをしません。'},
    {word:'さしみ',reading:'',def:'sashimi',pos:'Noun',sub:'5-6'},
    {word:'寿司',reading:'すし',def:'sushi',pos:'Noun',sub:'5-6'},
    {word:'ウィスキー',reading:'',def:'whiskey',pos:'Noun',sub:'5-6'},
    {word:'ビール',reading:'',def:'beer',pos:'Noun',sub:'5-6'},
    ...
    {word:'アニメ',reading:'',def:'anime',pos:'Noun',sub:'5-6'},
    {word:'ドラマ',reading:'',def:'drama, TV drama',pos:'Noun',sub:'5-6'},
    {word:'料理',reading:'りょうり',def:'cooking, cuisine',pos:'Noun',sub:'5-6'},
    {word:'韓国語',reading:'かんこくご',def:'Korean (language)',pos:'Noun',sub:'5-6'},
    {word:'ジャズ',reading:'',def:'jazz',pos:'Noun',sub:'5-6'},
    {word:'クラシック',reading:'',def:'classical music',pos:'Noun',sub:'5-6'},
    {word:'RPGゲーム',reading:'',def:'RPG game',pos:'Noun',sub:'5-6'},
    {word:'アクションゲーム',reading:'',def:'action game',pos:'Noun',sub:'5-6'},
    ...
    {word:'アルバイト',reading:'',def:'part-time job',pos:'Noun',sub:'5·Reading'},
    ...
    {word:'大変',reading:'たいへん',def:'tough; hard; terrible',pos:'Adj',adj:'na',sub:'5·Reading',ex:'日本語の勉強はたいへんです。'},
  ...
  'L6': [
    ...
    {word:'サラダ',reading:'',def:'salad',pos:'Noun',sub:'6-1'},
    ...
    {word:'キャンプ',reading:'',def:'camping',pos:'Noun',sub:'6-1'},
    {word:'おととい',reading:'',def:'day before yesterday',pos:'Noun',sub:'6-1'},
    {word:'あさって',reading:'',def:'day after tomorrow',pos:'Noun',sub:'6-1'},
    ...
    {word:'だけ',reading:'',def:'only, just',pos:'Expr',sub:'6-1',ex:'私は週末だけパンやでアルバイトします。'},
    {word:'あとで',reading:'',def:'later, afterwards',pos:'Expr',sub:'6-1'},
    {word:'そうじをします',reading:'',def:'to clean',pos:'Verb',grp:'G3',sub:'6-1',ex:'私は日曜日にそうじをします。'},
    ...
    {word:'そして',reading:'',def:'and then, and also',pos:'Conj',sub:'6-2',ex:'彼女はきれいです。そして、しんせつです'},
    {word:'楽しい',reading:'たのしい',def:'fun; enjoyable',pos:'Adj',adj:'i',sub:'6-2',ex:'パーティは楽しかったですか。'},
    {word:'上手',reading:'じょうず',def:'good at; skilled',pos:'Adj',adj:'na',sub:'6-2',ex:'田中さんは歌がじょうずです。'},
    {word:'にぎやか',reading:'',def:'lively, bustling',pos:'Adj',adj:'na',sub:'6-2',ex:'渋谷はにぎやかです。'},
    {word:'暖かい/温かい',reading:'あたたかい',def:'warm',pos:'Adj',adj:'i',sub:'6-2',ex:'はるはあたたかいです。'},
    {word:'会います',reading:'あいます',def:'to meet',pos:'Verb',grp:'G1',sub:'6-2',ex:'私は彼に会いました。'},
    {word:'チケット',reading:'',def:'ticket',pos:'Noun',sub:'6-2'},
    {word:'サンドイッチ',reading:'',def:'sandwich',pos:'Noun',sub:'6-2'},
    {word:'旅館',reading:'りょかん',def:'Japanese inn',pos:'Noun',sub:'6·Reading'},
    {word:'ホテル',reading:'',def:'hotel',pos:'Noun',sub:'6·Reading'},
    {word:'お土産',reading:'おみやげ',def:'souvenir',pos:'Noun',sub:'6·Reading'},
    {word:'おまんじゅう',reading:'',def:'sweet bun',pos:'Noun',sub:'6·Reading'},
  ...
  'L7': [
    ...
    {word:'テーブル',reading:'',def:'table',pos:'Noun',sub:'7-1'},
    {word:'本だな',reading:'ほんだな',def:'bookshelf',pos:'Noun',sub:'7-1'},
    {word:'たくさん',reading:'',def:'many, a lot',pos:'Expr',sub:'7-1'},
    {word:'庭',reading:'にわ',def:'garden, yard',pos:'Noun',sub:'7-1'},
    {word:'れいぞうこ',reading:'',def:'refrigerator',pos:'Noun',sub:'7-1'},
    {word:'チーズ',reading:'',def:'cheese',pos:'Noun',sub:'7-1'},
    {word:'ポケット',reading:'',def:'pocket',pos:'Noun',sub:'7-1'},
    {word:'トマト',reading:'',def:'tomato',pos:'Noun',sub:'7-1'},
    ...
    {word:'トイレ',reading:'',def:'toilet, bathroom',pos:'Noun',sub:'7-1'},
    {word:'お母さん',reading:'おかあさん',def:'mother (someone else\'s)',pos:'Noun',sub:'7-1'},
    {word:'ゴキブリ',reading:'',def:'cockroach',pos:'Noun',sub:'7-1'},
    {word:'たまご',reading:'',def:'egg',pos:'Noun',sub:'7-1'},
    {word:'ネズミ',reading:'',def:'mouse, rat',pos:'Noun',sub:'7-1'},
    {word:'ソファー',reading:'',def:'sofa',pos:'Noun',sub:'7-1'},
    {word:'金庫',reading:'きんこ',def:'safe, vault',pos:'Noun',sub:'7-1'},
    {word:'どろぼう',reading:'',def:'thief, burglar',pos:'Noun',sub:'7-1'},
    {word:'ベッド',reading:'',def:'bed',pos:'Noun',sub:'7-1'},
    {word:'子ども',reading:'こども',def:'child, children',pos:'Noun',sub:'7-1'},
    {word:'おもちゃ',reading:'',def:'toy',pos:'Noun',sub:'7-1'},
    {word:'スリッパ',reading:'',def:'slippers',pos:'Noun',sub:'7-1'},
    {word:'タオル',reading:'',def:'towel',pos:'Noun',sub:'7-1'},
    ...
    {word:'あります',reading:'',def:'to be (inanimate)',pos:'Verb',grp:'G1',sub:'7-1',ex:'へやにテーブルがあります。'},
    {word:'います',reading:'',def:'to be (animate)',pos:'Verb',grp:'G2',sub:'7-1',ex:'へやに田中さんがいます。'},
    {word:'ケーキ',reading:'',def:'cake',pos:'Noun',sub:'7-2'},
    {word:'ハンバーガー',reading:'',def:'hamburger',pos:'Noun',sub:'7-2'},
    {word:'ジュース',reading:'',def:'juice',pos:'Noun',sub:'7-2'},
    {word:'オレンジジュース',reading:'',def:'orange juice',pos:'Noun',sub:'7-2'},
    {word:'男',reading:'おとこ',def:'man, male',pos:'Noun',sub:'7-2'},
    {word:'女',reading:'おんな',def:'woman, female',pos:'Noun',sub:'7-2'},
    {word:'コーラ',reading:'',def:'cola',pos:'Noun',sub:'7-2'},
    {word:'全部',reading:'ぜんぶ',def:'all, everything',pos:'Noun',sub:'7-2'},
    {word:'円',reading:'えん',def:'yen',pos:'Noun',sub:'7-2'},
    {word:'おつり',reading:'',def:'change (money)',pos:'Noun',sub:'7-2'},
    {word:'ファーストフード',reading:'',def:'fast food',pos:'Noun',sub:'7-2'},
    ...
    {word:'ここ',reading:'',def:'here',pos:'Noun',sub:'7-3'},
    {word:'そこ',reading:'',def:'there',pos:'Noun',sub:'7-3'},
    {word:'あそこ',reading:'',def:'over there',pos:'Noun',sub:'7-3'},
    {word:'前',reading:'まえ',def:'in front, before',pos:'Noun',sub:'7-3'},
    {word:'後ろ',reading:'うしろ',def:'behind, back',pos:'Noun',sub:'7-3'},
    {word:'となり',reading:'',def:'next door',pos:'Noun',sub:'7-3'},
    {word:'ごみ',reading:'',def:'garbage, trash',pos:'Noun',sub:'7-3'},
    {word:'ごみばこ',reading:'',def:'trash can',pos:'Noun',sub:'7-3'},
    {word:'空',reading:'そら',def:'sky',pos:'Noun',sub:'7-3'},
    {word:'さいふ',reading:'',def:'wallet, purse',pos:'Noun',sub:'7-3'},
    {word:'駐車場',reading:'ちゅうしゃじょう',def:'parking lot',pos:'Noun',sub:'7-3'},
    {word:'蕎麦屋',reading:'そばや',def:'soba restaurant',pos:'Noun',sub:'7-3'},
    {word:'そば',reading:'',def:'near, beside, soba noodles',pos:'Noun',sub:'7-3',ex:'病院は家のそばにあります。'},
    ...
    {word:'ビル',reading:'',def:'building',pos:'Noun',sub:'7-3'},
  ...
  'L8': [
    ...
    {word:'きりん',reading:'',def:'giraffe',pos:'Noun',sub:'8-1'},
    ...
    {word:'多い',reading:'おおい',def:'many, a lot',pos:'Adj',adj:'i',sub:'8-1',ex:'中国は人が多いです。'},
    {word:'広い',reading:'ひろい',def:'wide, spacious',pos:'Adj',adj:'i',sub:'8-1',ex:'このへやはとてもひろいです。'},
    {word:'狭い',reading:'せまい',def:'narrow; small (space)',pos:'Adj',adj:'i',sub:'8-1',ex:'私のへやはせまいです。'},
    {word:'赤い',reading:'あかい',def:'red',pos:'Adj',adj:'i',sub:'8-1',ex:'りんごはあかいです。'},
    {word:'茶色い',reading:'ちゃいろい',def:'brown',pos:'Adj',adj:'i',sub:'8-1',ex:'チョコレートはちゃいろいです。'},
    {word:'数学',reading:'すうがく',def:'mathematics',pos:'Noun',sub:'8-2'},
    {word:'甘い物',reading:'あまいもの',def:'sweets, sweet things',pos:'Noun',sub:'8-2'},
    {word:'ふとん',reading:'',def:'futon',pos:'Noun',sub:'8-2'},
    ...
    {word:'〜タイプ',reading:'',def:'~type',pos:'Noun',sub:'8-2'},
    {word:'猿',reading:'さる',def:'monkey',pos:'Noun',sub:'8-2'},
    {word:'ライオン',reading:'',def:'lion',pos:'Noun',sub:'8-2'},
    {word:'好き',reading:'すき',def:'like, fond of',pos:'Adj',adj:'na',sub:'8-2',ex:'私はあまいものが好きです。'},
    {word:'嫌い',reading:'きらい',def:'dislike; hate',pos:'Adj',adj:'na',sub:'8-2',ex:'私は犬がきらいです。'},
    {word:'セーター',reading:'',def:'sweater',pos:'Noun',sub:'8-3'},
    {word:'四角い',reading:'しかくい',def:'square; rectangular',pos:'Adj',adj:'i',sub:'8-3',ex:'このビルはしかくいです。'},
    {word:'黄色い',reading:'きいろい',def:'yellow',pos:'Adj',adj:'i',sub:'8-3',ex:'バナナはきいろいです。'},
    {word:'丸い',reading:'まるい',def:'round; circular',pos:'Adj',adj:'i',sub:'8-3',ex:'このケーキはまるいです。'},
    {word:'ハンサム',reading:'',def:'handsome',pos:'Adj',adj:'na',sub:'8-3',ex:'本田さんはハンサムな人です。'},
    {word:'新鮮',reading:'しんせん',def:'fresh',pos:'Adj',adj:'na',sub:'8-3',ex:'このさかなはしんせんです。'},
    {word:'〜才',reading:'〜さい',def:'~years old',pos:'Noun',sub:'8-3'},
    {word:'タクシー',reading:'',def:'taxi',pos:'Noun',sub:'8-4'},
    {word:'バス',reading:'',def:'bus',pos:'Noun',sub:'8-4'},
    {word:'アイスクリーム',reading:'',def:'ice cream',pos:'Noun',sub:'8-4'},
    {word:'ほしい',reading:'',def:'want, desire',pos:'Adj',adj:'i',sub:'8-4',ex:'私はお金がほしいです。'},
    ...
    {word:'ピアノ',reading:'',def:'piano',pos:'Noun',sub:'8-5'},
    ...
    {word:'開けます',reading:'あけます',def:'to open',pos:'Verb',grp:'G2',sub:'8-5',ex:'私はまどをあけます。'},
    ...
    {word:'アプリ',reading:'',def:'app',pos:'Noun',sub:'8-6'},
    {word:'コート',reading:'',def:'coat',pos:'Noun',sub:'8-6'},
    {word:'強い',reading:'つよい',def:'strong',pos:'Adj',adj:'i',sub:'8-6',ex:'田中さんはつよいです。'},
    {word:'気持ちいい',reading:'きもちいい',def:'feels good, comfortable',pos:'Adj',adj:'i',sub:'8-6',ex:'彼はとてもきもちよさそうです。'},
    {word:'苦い',reading:'にがい',def:'bitter',pos:'Adj',adj:'i',sub:'8-6',ex:'このコーヒーはにがいです。'},
    {word:'寂しい',reading:'さびしい',def:'lonely',pos:'Adj',adj:'i',sub:'8-6',ex:'私はとてもさびしいです。'},
    {word:'悲しい',reading:'かなしい',def:'sad',pos:'Adj',adj:'i',sub:'8-6',ex:'彼女はとてもかなしそうです。'},
    {word:'苦しい',reading:'くるしい',def:'painful; hard (suffering)',pos:'Adj',adj:'i',sub:'8-6',ex:'田中さんは苦しそうです。'},
    {word:'嬉しい',reading:'うれしい',def:'happy; glad',pos:'Adj',adj:'i',sub:'8-6',ex:'彼はうれしそうです。'},
    {word:'痛い',reading:'いたい',def:'painful; sore',pos:'Adj',adj:'i',sub:'8-6',ex:'私は足がいたいです。'},
    ...
    {word:'スポーツマン',reading:'',def:'sportsman',pos:'Noun',sub:'8·Reading'},
    {word:'高校生',reading:'こうこうせい',def:'high school student',pos:'Noun',sub:'8·Reading'},
    {word:'色々',reading:'いろいろ',def:'various; all kinds of',pos:'Adj',adj:'na',sub:'8·Reading',ex:'私はいろいろなおさけを飲みます。'},
  ],
  'L9': [
    {word:'消しゴム',reading:'けしゴム',def:'eraser',pos:'Noun',sub:'9-1'},
    {word:'ラジオ',reading:'',def:'radio',pos:'Noun',sub:'9-1'},
    {word:'エアコン',reading:'',def:'air conditioner',pos:'Noun',sub:'9-1'},
    {word:'電気',reading:'でんき',def:'electricity, light',pos:'Noun',sub:'9-1'},
    {word:'引っ越し',reading:'ひっこし',def:'moving (house)',pos:'Noun',sub:'9-1'},
    {word:'暗い',reading:'くらい',def:'dark; gloomy',pos:'Adj',adj:'i',sub:'9-1',ex:'この部屋は暗いです。'},
    ...
    {word:'閉めます',reading:'しめます',def:'to close; to shut',pos:'Verb',grp:'G2',sub:'9-1',ex:'ドアを閉めます。'},
    ...
    {word:'引っ越します',reading:'ひっこします',def:'to move (house)',pos:'Verb',grp:'G1',sub:'9-1',ex:'山田さんは明日ひっこします。'},
    {word:'大丈夫',reading:'だいじょうぶ',def:'OK; all right; fine',pos:'Adj',adj:'na',sub:'9-1',ex:'だいじょうぶです。ありがとう。'},
    {word:'塩',reading:'しお',def:'salt',pos:'Noun',sub:'9-2'},
    {word:'カメラマン',reading:'',def:'photographer',pos:'Noun',sub:'9-2'},
    {word:'モデル',reading:'',def:'model',pos:'Noun',sub:'9-2'},
    {word:'ゆっくり',reading:'',def:'slowly; take your time',pos:'Adj',adj:'na',sub:'9-2',ex:'父はゆっくりと歩きます。'},
    ...
    {word:'ロビー',reading:'',def:'lobby',pos:'Noun',sub:'9-3'},
    {word:'ギター',reading:'',def:'guitar',pos:'Noun',sub:'9-3'},
  ...
  'L10': [
    ...
    {word:'たぶん',reading:'',def:'probably, maybe',pos:'Adv',sub:'10-1',ex:'明日はたぶんさむいです。'},
    ...
    {word:'カンニング',reading:'',def:'cheating (on exam)',pos:'Noun',sub:'10-2'},
    {word:'ルール',reading:'',def:'rule',pos:'Noun',sub:'10-2'},
    {word:'ゴミ',reading:'',def:'garbage, trash',pos:'Noun',sub:'10-2'},
    {word:'ペット',reading:'',def:'pet',pos:'Noun',sub:'10-2'},
    ...
    {word:'ジョギング',reading:'',def:'jogging',pos:'Noun',sub:'10-3'},
    {word:'ハム',reading:'',def:'ham',pos:'Noun',sub:'10-3'},
    {word:'牛乳',reading:'ぎゅうにゅう',def:'milk',pos:'Noun',sub:'10-3'},
    {word:'恋人',reading:'こいびと',def:'lover, partner',pos:'Noun',sub:'10-3'},
    {word:'シャワー',reading:'',def:'shower',pos:'Noun',sub:'10-3'},
    ...
    {word:'かかります',reading:'',def:'to take (time/money)',pos:'Verb',grp:'G1',sub:'10-4',ex:'えきからうちまで３０分かかります。'},
    {word:'まず',reading:'',def:'first, to begin with',pos:'Adv',sub:'10-4',ex:'まず、新大久保で山手線にのります。'},
    {word:'雨',reading:'あめ',def:'rain',pos:'Noun',sub:'10-5'},
    {word:'ミルク',reading:'',def:'milk',pos:'Noun',sub:'10-5'},
    ...
    {word:'おにぎり',reading:'',def:'rice ball',pos:'Noun',sub:'10-5'},
    ...
    {word:'ボールペン',reading:'',def:'ballpoint pen',pos:'Noun',sub:'10·Reading'},
  ...
  'L11': [
    ...
    {word:'デザイン',reading:'',def:'design',pos:'Noun',sub:'11-1'},
    {word:'色',reading:'いろ',def:'color',pos:'Noun',sub:'11-1'},
    {word:'牛丼',reading:'ぎゅうどん',def:'beef bowl',pos:'Noun',sub:'11-1'},
    {word:'うどん',reading:'',def:'udon noodles',pos:'Noun',sub:'11-1'},
    {word:'ずっと',reading:'',def:'all along, the whole time',pos:'Adv',sub:'11-1',ex:'この店のほうがずっとやすいです。'},
    {word:'速い',reading:'はやい',def:'fast; quick',pos:'Adj',adj:'i',sub:'11-1',ex:'くるまはとてもはやいです。'},
    {word:'若い',reading:'わかい',def:'young',pos:'Adj',adj:'i',sub:'11-1',ex:'彼女はとても若いです。'},
    {word:'かっこいい',reading:'',def:'cool, stylish',pos:'Adj',adj:'i',sub:'11-1',ex:'新幹線はかっこいいです。'},
    {word:'決めます',reading:'きめます',def:'to decide',pos:'Verb',grp:'G2',sub:'11-1'},
    {word:'あげます',reading:'',def:'to raise, give',pos:'Verb',grp:'G2',sub:'11-1',ex:'私は田中さんに本をあげます。'},
    ...
    {word:'甘い',reading:'あまい',def:'sweet',pos:'Adj',adj:'i',sub:'11-2',ex:'あまいお菓子を食べます。'},
    ...
    {word:'すきやき',reading:'',def:'sukiyaki',pos:'Noun',sub:'11-3'},
    {word:'野球',reading:'やきゅう',def:'baseball',pos:'Noun',sub:'11-3'},
    {word:'スカート',reading:'',def:'skirt',pos:'Noun',sub:'11-4'},
    {word:'ズボン',reading:'',def:'trousers, pants',pos:'Noun',sub:'11-4'},
    {word:'不動産屋',reading:'ふどうさんや',def:'real estate agency',pos:'Noun',sub:'11-4'},
    {word:'二日よい',reading:'ふつかよい',def:'hangover',pos:'Noun',sub:'11-4'},
    {word:'派手',reading:'はで',def:'showy; flashy',pos:'Adj',adj:'na',sub:'11-4',ex:'このぼうしははでです。'},
    {word:'地味',reading:'じみ',def:'plain; modest',pos:'Adj',adj:'na',sub:'11-4',ex:'このセーターはじみです。'},
    {word:'ちょうど',reading:'',def:'exactly',pos:'Adv',sub:'11-4',ex:'このくつはちょうどいいです。'},
    {word:'字',reading:'じ',def:'character, handwriting',pos:'Noun',sub:'11-5'},
    {word:'説明',reading:'せつめい',def:'explanation',pos:'Noun',sub:'11-5'},
    {word:'ファイル',reading:'',def:'file',pos:'Noun',sub:'11-5'},
    {word:'プリントアウト',reading:'',def:'printout',pos:'Noun',sub:'11-5'},
    {word:'デジカメ',reading:'',def:'digital camera',pos:'Noun',sub:'11-5'},
    {word:'マニュアル',reading:'',def:'manual',pos:'Noun',sub:'11-5'},
    {word:'セットアップ',reading:'',def:'setup',pos:'Noun',sub:'11-5'},
    {word:'靴屋',reading:'くつや',def:'shoe store',pos:'Noun',sub:'11-5'},
    {word:'分かりやすい',reading:'わかりやすい',def:'easy to understand',pos:'Adj',adj:'i',sub:'11-5',ex:'この教科書はわかりやすいです。'},
    ...
    {word:'いくら',reading:'',def:'how much',pos:'Noun',sub:'11·Reading'},
    {word:'席',reading:'せき',def:'seat',pos:'Noun',sub:'11·Reading'},
    {word:'カラオケ',reading:'',def:'karaoke',pos:'Noun',sub:'11·Reading'},
  ...
  'L12': [
    ...
    {word:'ダイエット',reading:'',def:'diet',pos:'Noun',sub:'12-1'},
    {word:'電話代',reading:'でんわだい',def:'phone bill',pos:'Noun',sub:'12-1'},
    {word:'危ない',reading:'あぶない',def:'dangerous',pos:'Adj',adj:'i',sub:'12-1',ex:'都会はべんりですが、あぶないです。'},
    {word:'はずかしい',reading:'',def:'embarrassing, shy',pos:'Adj',adj:'i',sub:'12-1',ex:'私はとてもはずかしかったです。'},
    {word:'押します',reading:'おします',def:'to push',pos:'Verb',grp:'G1',sub:'12-1'},
    ...
    {word:'キッチン',reading:'',def:'kitchen',pos:'Noun',sub:'12-2'},
    {word:'さっき',reading:'',def:'a little while ago',pos:'Adv',sub:'12-2',ex:'さっき田中さんに会いました。'},
    {word:'じっと',reading:'',def:'still, motionless',pos:'Adv',sub:'12-2',ex:'田中さんはじっとすわっています。'},
    {word:'変',reading:'へん',def:'strange; odd',pos:'Adj',adj:'na',sub:'12-2',ex:'見て！あそこに変な人がいるよ。'},
    ...
    {word:'ちょっと',reading:'',def:'a little; just a moment',pos:'Adv',sub:'12-3',ex:'このコートはちょっとたかいです。'},
    {word:'美人',reading:'びじん',def:'beautiful woman',pos:'Noun',sub:'12-4'},
    {word:'金持ち',reading:'かねもち',def:'rich person',pos:'Noun',sub:'12-4'},
    {word:'しょうゆ',reading:'',def:'soy sauce',pos:'Noun',sub:'12-4'},
    {word:'ヘルシー',reading:'',def:'healthy',pos:'Noun',sub:'12-4'},
    ...
    {word:'せまい',reading:'',def:'narrow',pos:'Adj',adj:'i',sub:'12-4'},
    {word:'優しい',reading:'やさしい',def:'kind; gentle',pos:'Adj',adj:'i',sub:'12-4',ex:'山田さんはやさしいです。'},
    ...
    {word:'ストーリー',reading:'',def:'story',pos:'Noun',sub:'12-5'},
    {word:'電車代',reading:'でんしゃだい',def:'train fare',pos:'Noun',sub:'12-5'},
    {word:'すてき',reading:'',def:'wonderful, lovely',pos:'Adj',adj:'na',sub:'12-5',ex:'すてきなセーターですね。'},
    {word:'美しい',reading:'うつくしい',def:'beautiful',pos:'Adj',adj:'i',sub:'12-5',ex:'山本さんは美しいです。'},
    ...
    {word:'おじいさん',reading:'',def:'grandfather, old man',pos:'Noun',sub:'12·Reading'},
    {word:'教室',reading:'きょうしつ',def:'classroom',pos:'Noun',sub:'12·Reading'},
    {word:'きゅうり',reading:'',def:'cucumber',pos:'Noun',sub:'12·Reading'},
    {word:'ぶどう',reading:'',def:'grapes',pos:'Noun',sub:'12·Reading'},
    {word:'めずらしい',reading:'',def:'rare, unusual',pos:'Adj',adj:'i',sub:'12·Reading',ex:'これはめずらしいおさけです。'},
    {word:'遠い',reading:'とおい',def:'far; distant',pos:'Adj',adj:'i',sub:'12·Reading',ex:'学校はとても遠いです。'},
  ...
  'Q': [
    ...
    {word:'どこの',reading:'どこの',def:'Where is it from',pos:'Expr',sub:'Question',exprKey:'どこの くるま ですか'},
    {word:'いつ',reading:'いつ',def:'When',pos:'Expr',sub:'Question',exprKey:'パーティは いつですか'},
    {word:'どう',reading:'どう',def:'How',pos:'Expr',sub:'Question',exprKey:'えいがは どう でしたか'},
    {word:'どうして',reading:'どうして',def:'Why',pos:'Expr',sub:'Question',exprKey:'どうしてですか'},
    {word:'いくら',reading:'いくら',def:'How much (cost)',pos:'Expr',sub:'Question',exprKey:'いくら かかりますか'},
    {word:'どれ',reading:'どれ',def:'Which one (3+ options)',pos:'Expr',sub:'Question',exprKey:'どれが いちばん 好きですか'},
    {word:'どちら',reading:'どちら',def:'Which (of two options)',pos:'Expr',sub:'Question',exprKey:'AとBと どちらが 好きですか'},
    {word:'どんな',reading:'どんな',def:'What kind of',pos:'Expr',sub:'Question',exprKey:'どんな ＋ [Noun] ＋ ですか'},
    {word:'どうやって',reading:'どうやって',def:'How / By what route',pos:'Expr',sub:'Question',exprKey:'どうやって 行きますか'},
    {word:'どのぐらい',reading:'どのぐらい / どのくらい',def:'How long / How much',pos:'Expr',sub:'Question',exprKey:'どのぐらい かかりますか'},
    {word:'なにで',reading:'なにで',def:'By what means / transport',pos:'Expr',sub:'Question',exprKey:'なにで 行きますか'},
    {word:'何時',reading:'なんじ',def:'What time',pos:'Expr',sub:'Question',exprKey:'なんじに おきますか'},
    {word:'何曜日',reading:'なんようび',def:'What day of the week',pos:'Expr',sub:'Question',exprKey:'なんようび ですか'},
    {word:'何月',reading:'なんがつ',def:'What month',pos:'Expr',sub:'Question',exprKey:'なんがつ ですか'},
    {word:'何日',reading:'なんにち',def:'What day of the month',pos:'Expr',sub:'Question',exprKey:'なんにち ですか'},
    {word:'何時間',reading:'なんじかん',def:'How many hours',pos:'Expr',sub:'Question',exprKey:'なんじかん かかりますか'},
    {word:'何日間',reading:'なんにちかん',def:'How many days',pos:'Expr',sub:'Question',exprKey:'なんにちかん かかりますか'},
    {word:'何人',reading:'なんにん',def:'How many people',pos:'Expr',sub:'Question',exprKey:'なんにん ですか'},
    {word:'何番',reading:'なんばん',def:'What number',pos:'Expr',sub:'Question',exprKey:'でんわばんごうは なんばん ですか'},
    {word:'どうしましたか',reading:'どうしましたか',def:'What happened?',pos:'Expr',sub:'Question',exprKey:'どうしましたか'},
    {word:'てもいいですか',reading:'〜てもいいですか',def:'Asking for permission',pos:'Expr',sub:'Question',exprKey:'写真を とってもいいですか'},
    {word:'ましょうか',reading:'〜ましょうか',def:'Offering to do / Shall I?',pos:'Expr',sub:'Question',exprKey:'かばんを 持ちましょうか'},
  ],
};
const oppData = {};
kanjiData['S1'] = {
...
const sheetData = {
  verbs:  [{'word':'食べます','reading':'たべます','eng':'to eat','dict':'たべる','te':'たべて','grp':'2','lvl':'5'},{'word':'飲みます','reading':'のみます','eng':'to drink','dict':'のむ','te':'のんで','grp':'1','lvl':'5'},{'word':'読みます','reading':'よみます','eng':'to read','dict':'よむ','te':'よんで','grp':'1','lvl':'5'},{'word':'見ます','reading':'みます','eng':'to see','dict':'みる','te':'みて','grp':'2','lvl':'5'},{'word':'書きます','reading':'かきます','eng':'to write','dict':'かく','te':'かいて','grp':'1','lvl':'5'},{'word':'聞きます','reading':'ききます','eng':'to listen','dict':'きく','te':'きいて','grp':'1','lvl':'5'},{'word':'話します','reading':'はなします','eng':'to speak','dict':'はなす','te':'はなして','grp':'1','lvl':'5'},{'word':'買います','reading':'かいます','eng':'to buy','dict':'かう','te':'かって','grp':'1','lvl':'5'},{'word':'します','reading':'','eng':'to do','dict':'する','te':'して','grp':'3','lvl':'5'},{'word':'勉強をします','reading':'べんきょうをします','eng':'to study','dict':'べんきょうをする','te':'べんきょうをして','grp':'3','lvl':'5'},{'word':'テニスをします','reading':'','eng':'to play tennis','dict':'テニスをする','te':'テニスをして','grp':'3','lvl':'5'},{'word':'仕事をします','reading':'しごとをします','eng':'to work','dict':'しごとをする','te':'しごとをして','grp':'3','lvl':'5'},{'word':'吸います','reading':'すいます','eng':'to smoke; to inhale','dict':'すう','te':'すって','grp':'1','lvl':'5'},{'word':'行きます','reading':'いきます','eng':'to go','dict':'いく','te':'いって','grp':'1','lvl':'5'},{'word':'来ます','reading':'きます','eng':'to come','dict':'くる','te':'きて','grp':'3','lvl':'5'},{'word':'帰ります','reading':'かえります','eng':'to return','dict':'かえる','te':'かえって','grp':'1','lvl':'5'},{'word':'泳ぎます','reading':'およぎます','eng':'to swim','dict':'およぐ','te':'およいで','grp':'1','lvl':'5'},{'word':'起きます','reading':'おきます','eng':'to wake up','dict':'おきる','te':'おきて','grp':'2','lvl':'5'},{'word':'磨きます','reading':'みがきます','eng':'to brush; to polish','dict':'みがく','te':'みがいて','grp':'1','lvl':'5'},{'word':'入ります','reading':'はいります','eng':'to enter','dict':'はいる','te':'はいって','grp':'1','lvl':'5'},{'word':'寝ます','reading':'ねます','eng':'to sleep; to go to bed','dict':'ねる','te':'ねて','grp':'2','lvl':'5'},{'word':'そうじをします','reading':'','eng':'to clean','dict':'そうじをする','te':'そうじをして','grp':'3','lvl':'6'},{'word':'作ります','reading':'つくります','eng':'to make; to create','dict':'つくる','te':'つくって','grp':'1','lvl':'6'},{'word':'会います','reading':'あいます','eng':'to meet','dict':'あう','te':'あって','grp':'1','lvl':'6'},{'word':'泊まります','reading':'とまります','eng':'to stay (overnight)','dict':'とまる','te':'とまって','grp':'1','lvl':'6'},{'word':'あります','reading':'','eng':'to be (inanimate)','dict':'ある','te':'あって','grp':'1','lvl':'7'},{'word':'います','reading':'','eng':'to be (animate)','dict':'いる','te':'いて','grp':'2','lvl':'7'},{'word':'乗ります','reading':'のります','eng':'to ride; to get on','dict':'のる','te':'のって','grp':'1','lvl':'8'},{'word':'描きます','reading':'かきます','eng':'to draw; to paint','dict':'かく','te':'かいて','grp':'1','lvl':'8'},{'word':'育てます','reading':'そだてます','eng':'to raise; to bring up','dict':'そだてる','te':'そだてて','grp':'2','lvl':'8'},{'word':'編みます','reading':'あみます','eng':'to knit; to braid','dict':'あむ','te':'あんで','grp':'1','lvl':'8'},{'word':'弾きます','reading':'ひきます','eng':'to play (instrument)','dict':'ひく','te':'ひいて','grp':'1','lvl':'8'},{'word':'釣りをします','reading':'つりをします','eng':'to fish; go fishing','dict':'つりをする','te':'つりをして','grp':'3','lvl':'8'},{'word':'待ちます','reading':'まちます','eng':'to wait','dict':'まつ','te':'まって','grp':'1','lvl':'8'},{'word':'死にます','reading':'しにます','eng':'to die','dict':'しぬ','te':'しんで','grp':'1','lvl':'8'},{'word':'呼びます','reading':'よびます','eng':'to call; to invite','dict':'よぶ','te':'よんで','grp':'1','lvl':'8'},{'word':'開けます','reading':'あけます','eng':'to open','dict':'あける','te':'あけて','grp':'2','lvl':'8'},{'word':'歌います','reading':'うたいます','eng':'to sing','dict':'うたう','te':'うたって','grp':'1','lvl':'8'},{'word':'持ちます','reading':'もちます','eng':'to have/hold','dict':'もつ','te':'もって','grp':'1','lvl':'9'},{'word':'貸します','reading':'かします','eng':'to lend','dict':'かす','te':'かして','grp':'1','lvl':'9'},{'word':'借ります','reading':'かります','eng':'to borrow','dict':'かりる','te':'かりて','grp':'2','lvl':'9'},{'word':'手伝います','reading':'てつだいます','eng':'to help; to assist','dict':'てつだう','te':'てつだって','grp':'1','lvl':'9'},{'word':'閉めます','reading':'しめます','eng':'to close; to shut','dict':'しめる','te':'しめて','grp':'2','lvl':'9'},{'word':'消します','reading':'けします','eng':'to turn off; to erase','dict':'けす','te':'けして','grp':'1','lvl':'9'},{'word':'点けます','reading':'つけます','eng':'to turn on (a light / device)','dict':'つける','te':'つけて','grp':'2','lvl':'9'},{'word':'忘れます','reading':'わすれます','eng':'to forget','dict':'わすれる','te':'わすれて','grp':'2','lvl':'9'},{'word':'引っ越します','reading':'ひっこします','eng':'to move (house)','dict':'ひっこす','te':'ひっこして','grp':'1','lvl':'9'},{'word':'立ちます','reading':'たちます','eng':'to stand','dict':'たつ','te':'たって','grp':'1','lvl':'9'},{'word':'飛びます','reading':'とびます','eng':'to fly; to jump','dict':'とぶ','te':'とんで','grp':'1','lvl':'9'},{'word':'言います','reading':'いいます','eng':'to say','dict':'いう','te':'いって','grp':'1','lvl':'9'},{'word':'教えます','reading':'おしえます','eng':'to teach/tell','dict':'おしえる','te':'おしえて','grp':'2','lvl':'9'},{'word':'見せます','reading':'みせます','eng':'to show','dict':'みせる','te':'みせて','grp':'2','lvl':'9'},{'word':'歩きます','reading':'あるきます','eng':'to walk','dict':'あるく','te':'あるいて','grp':'1','lvl':'9'},{'word':'取ります','reading':'とります','eng':'to take; to get','dict':'とる','te':'とって','grp':'1','lvl':'9'},{'word':'笑います','reading':'わらいます','eng':'to laugh; to smile','dict':'わらう','te':'わらって','grp':'1','lvl':'9'},{'word':'遊びます','reading':'あそびます','eng':'to play; to have fun','dict':'あそぶ','te':'あそんで','grp':'1','lvl':'9'},{'word':'踊ります','reading':'おどります','eng':'to dance','dict':'おどる','te':'おどって','grp':'1','lvl':'9'},{'word':'走ります','reading':'はしります','eng':'to run','dict':'はしる','te':'はしって','grp':'1','lvl':'9'},{'word':'出ます','reading':'でます','eng':'to leave','dict':'でる','te':'でて','grp':'2','lvl':'9'},{'word':'受けます','reading':'うけます','eng':'to take (exam); to receive','dict':'うける','te':'うけて','grp':'2','lvl':'10'},{'word':'止めます','reading':'とめます','eng':'to stop; to park','dict':'とめる','te':'とめて','grp':'2','lvl':'10'},{'word':'出します','reading':'だします','eng':'to take out','dict':'だす','te':'だして','grp':'1','lvl':'10'},{'word':'入ります','reading':'はいります','eng':'to enter','dict':'はいる','te':'はいって','grp':'1','lvl':'10'},{'word':'洗います','reading':'あらいます','eng':'to wash','dict':'あらう','te':'あらって','grp':'1','lvl':'10'},{'word':'浴びます','reading':'あびます','eng':'to take (shower); to bathe','dict':'あびる','te':'あびて','grp':'2','lvl':'10'},{'word':'乗ります','reading':'のります','eng':'to ride; to get on','dict':'のる','te':'のって','grp':'1','lvl':'10'},{'word':'降ります','reading':'おります','eng':'to get off; to get out','dict':'おりる','te':'おりて','grp':'2','lvl':'10'},{'word':'乗り換えます','reading':'のりかえます','eng':'to transfer (transport)','dict':'のりかえる','te':'のりかえて','grp':'2','lvl':'10'},{'word':'かかります','reading':'','eng':'to take (time/money)','dict':'かかる','te':'かかって','grp':'1','lvl':'10'},{'word':'持って行きます','reading':'もっていきます','eng':'to take (something)','dict':'もっていく','te':'もっていって','grp':'1','lvl':'10'},{'word':'買って行きます','reading':'かっていきます','eng':'to buy and go','dict':'かっていく','te':'かっていって','grp':'1','lvl':'10'},{'word':'作って行きます','reading':'つくっていきます','eng':'to make and bring','dict':'つくっていく','te':'つくっていって','grp':'1','lvl':'10'},{'word':'つれて行きます','reading':'つれていきます','eng':'to take someone along','dict':'つれていく','te':'つれていって','grp':'1','lvl':'10'},{'word':'持って来ます','reading':'もってきます','eng':'to bring (something)','dict':'もってくる','te':'もってきて','grp':'3','lvl':'10'},{'word':'買って来ます','reading':'かってきます','eng':'to buy and come','dict':'かってくる','te':'かってきて','grp':'3','lvl':'10'},{'word':'買って帰ります','reading':'かってかえります','eng':'to buy and return','dict':'かってかえる','te':'かってかえって','grp':'1','lvl':'10'},{'word':'行って来ます','reading':'いってきます','eng':'to go and come back','dict':'いってくる','te':'いってきて','grp':'3','lvl':'10'},{'word':'持って帰ります','reading':'もってかえります','eng':'to take home','dict':'もってかえる','te':'もってかえって','grp':'1','lvl':'10'},{'word':'決めます','reading':'きめます','eng':'to decide','dict':'きめる','te':'きめて','grp':'2','lvl':'11'},{'word':'あげます','reading':'','eng':'to raise, give','dict':'あげる','te':'あげて','grp':'2','lvl':'11'},{'word':'足ります','reading':'たります','eng':'to be enough; to suffice','dict':'たりる','te':'たりて','grp':'2','lvl':'11'},{'word':'間違えます','reading':'まちがえます','eng':'to make a mistake','dict':'まちがえる','te':'まちがえて','grp':'2','lvl':'11'},{'word':'履きます','reading':'はきます','eng':'to wear (shoes / trousers)','dict':'はく','te':'はいて','grp':'1','lvl':'11'},{'word':'使います','reading':'つかいます','eng':'to use','dict':'つかう','te':'つかって','grp':'1','lvl':'11'},{'word':'覚えます','reading':'おぼえます','eng':'to memorise; to remember','dict':'おぼえる','te':'おぼえて','grp':'2','lvl':'11'},{'word':'住みます','reading':'すみます','eng':'to live; to reside','dict':'すむ','te':'すんで','grp':'1','lvl':'11'},{'word':'押します','reading':'おします','eng':'to push','dict':'おす','te':'おして','grp':'1','lvl':'12'},{'word':'遅れます','reading':'おくれます','eng':'to be late; to be delayed','dict':'おくれる','te':'おくれて','grp':'2','lvl':'12'},{'word':'座ります','reading':'すわります','eng':'to sit down','dict':'すわる','te':'すわって','grp':'1','lvl':'12'},{'word':'捨てます','reading':'すてます','eng':'to throw away; to discard','dict':'すてる','te':'すてて','grp':'2','lvl':'12'},{'word':'触ります','reading':'さわります','eng':'to touch','dict':'さわる','te':'さわって','grp':'1','lvl':'12'},{'word':'片付けます','reading':'かたづけます','eng':'to tidy up; to put away','dict':'かたづける','te':'かたづけて','grp':'2','lvl':'12'},{'word':'着ます','reading':'きます','eng':'to wear; to put on (clothes)','dict':'きる','te':'きて','grp':'2','lvl':'12'},{'word':'入れます','reading':'いれます','eng':'to put in; to insert','dict':'いれる','te':'いれて','grp':'2','lvl':'12'},{'word':'降ります','reading':'ふります','eng':'to fall (rain, snow)','dict':'ふる','te':'ふって','grp':'1','lvl':'12'},{'word':'出かけます','reading':'でかけます','eng':'to go out','dict':'でかける','te':'でかけて','grp':'2','lvl':'12'},{'word':'辞めます','reading':'やめます','eng':'to quit','dict':'やめる','te':'やめて','grp':'2','lvl':'12'},{'word':'疲れます','reading':'つかれます','eng':'to get tired','dict':'つかれる','te':'つかれて','grp':'2','lvl':'12'},{'word':'迷います','reading':'まよいます','eng':'to get lost; to be lost','dict':'まよう','te':'まよって','grp':'1','lvl':'12'},{'word':'答えます','reading':'こたえます','eng':'to answer; to reply','dict':'こたえる','te':'こたえて','grp':'2','lvl':'12'}],
  adj:    [{'word':'大きい','reading':'おおきい','eng':'big, large','adj':'i','lvl':'3'},{'word':'小さい','reading':'ちいさい','eng':'small, little','adj':'i','lvl':'3'},{'word':'高い','reading':'たかい','eng':'tall, expensive','adj':'i','lvl':'3'},{'word':'安い','reading':'やすい','eng':'cheap','adj':'i','lvl':'3'},{'word':'低い','reading':'ひくい','eng':'low; short (height)','adj':'i','lvl':'3'},{'word':'長い','reading':'ながい','eng':'long','adj':'i','lvl':'3'},{'word':'短い','reading':'みじかい','eng':'short (length)','adj':'i','lvl':'3'},{'word':'新しい','reading':'あたらしい','eng':'new','adj':'i','lvl':'3'},{'word':'古い','reading':'ふるい','eng':'old (thing)','adj':'i','lvl':'3'},{'word':'おいしい','reading':'','eng':'delicious','adj':'i','lvl':'3'},{'word':'まずい','reading':'','eng':'bad tasting','adj':'i','lvl':'3'},{'word':'難しい','reading':'むずかしい','eng':'difficult','adj':'i','lvl':'3'},{'word':'易しい','reading':'やさしい','eng':'easy','adj':'i','lvl':'3'},{'word':'暑い','reading':'あつい','eng':'hot (weather)','adj':'i','lvl':'3'},{'word':'寒い','reading':'さむい','eng':'cold (weather)','adj':'i','lvl':'3'},{'word':'いい','reading':'','eng':'good','adj':'i','lvl':'3'},{'word':'悪い','reading':'わるい','eng':'bad; wrong','adj':'i','lvl':'3'},{'word':'面白い','reading':'おもしろい','eng':'interesting; funny','adj':'i','lvl':'3'},{'word':'つまらない','reading':'','eng':'boring','adj':'i','lvl':'3'},{'word':'重い','reading':'おもい','eng':'heavy','adj':'i','lvl':'3'},{'word':'軽い','reading':'かるい','eng':'light (weight)','adj':'i','lvl':'3'},{'word':'白い','reading':'しろい','eng':'white','adj':'i','lvl':'3'},{'word':'黒い','reading':'くろい','eng':'black','adj':'i','lvl':'3'},{'word':'うるさい','reading':'','eng':'noisy, loud','adj':'i','lvl':'3'},{'word':'忙しい','reading':'いそがしい','eng':'busy','adj':'i','lvl':'3'},{'word':'汚い','reading':'きたない','eng':'dirty; messy','adj':'i','lvl':'3'},{'word':'親切','reading':'しんせつ','eng':'kind, friendly','adj':'na','lvl':'3'},{'word':'便利','reading':'べんり','eng':'convenient; useful','adj':'na','lvl':'3'},{'word':'きれい','reading':'','eng':'pretty, clean','adj':'na','lvl':'3'},{'word':'静か','reading':'しずか','eng':'quiet; calm','adj':'na','lvl':'3'},{'word':'元気','reading':'げんき','eng':'healthy, energetic','adj':'na','lvl':'3'},{'word':'大切','reading':'たいせつ','eng':'important','adj':'na','lvl':'3'},{'word':'ハンサム','reading':'','eng':'handsome','adj':'na','lvl':'3'},{'word':'暇','reading':'ひま','eng':'free time; not busy','adj':'na','lvl':'3'},{'word':'大変','reading':'たいへん','eng':'tough; hard; terrible','adj':'na','lvl':'3'},{'word':'近い','reading':'ちかい','eng':'near; close','adj':'i','lvl':'3'},{'word':'大変','reading':'たいへん','eng':'tough; hard; terrible','adj':'na','lvl':'5'},{'word':'楽しい','reading':'たのしい','eng':'fun; enjoyable','adj':'i','lvl':'6'},{'word':'上手','reading':'じょうず','eng':'good at; skilled','adj':'na','lvl':'6'},{'word':'にぎやか','reading':'','eng':'lively, bustling','adj':'na','lvl':'6'},{'word':'暖かい/温かい','reading':'あたたかい','eng':'warm','adj':'i','lvl':'6'},{'word':'有名','reading':'ゆうめい','eng':'famous','adj':'na','lvl':'7'},{'word':'多い','reading':'おおい','eng':'many, a lot','adj':'i','lvl':'8'},{'word':'広い','reading':'ひろい','eng':'wide, spacious','adj':'i','lvl':'8'},{'word':'狭い','reading':'せまい','eng':'narrow; small (space)','adj':'i','lvl':'8'},{'word':'赤い','reading':'あかい','eng':'red','adj':'i','lvl':'8'},{'word':'茶色い','reading':'ちゃいろい','eng':'brown','adj':'i','lvl':'8'},{'word':'好き','reading':'すき','eng':'like, fond of','adj':'na','lvl':'8'},{'word':'嫌い','reading':'きらい','eng':'dislike; hate','adj':'na','lvl':'8'},{'word':'四角い','reading':'しかくい','eng':'square; rectangular','adj':'i','lvl':'8'},{'word':'黄色い','reading':'きいろい','eng':'yellow','adj':'i','lvl':'8'},{'word':'丸い','reading':'まるい','eng':'round; circular','adj':'i','lvl':'8'},{'word':'ハンサム','reading':'','eng':'handsome','adj':'na','lvl':'8'},{'word':'新鮮','reading':'しんせん','eng':'fresh','adj':'na','lvl':'8'},{'word':'ほしい','reading':'','eng':'want, desire','adj':'i','lvl':'8'},{'word':'強い','reading':'つよい','eng':'strong','adj':'i','lvl':'8'},{'word':'気持ちいい','reading':'きもちいい','eng':'feels good, comfortable','adj':'i','lvl':'8'},{'word':'苦い','reading':'にがい','eng':'bitter','adj':'i','lvl':'8'},{'word':'寂しい','reading':'さびしい','eng':'lonely','adj':'i','lvl':'8'},{'word':'悲しい','reading':'かなしい','eng':'sad','adj':'i','lvl':'8'},{'word':'苦しい','reading':'くるしい','eng':'painful; hard (suffering)','adj':'i','lvl':'8'},{'word':'嬉しい','reading':'うれしい','eng':'happy; glad','adj':'i','lvl':'8'},{'word':'痛い','reading':'いたい','eng':'painful; sore','adj':'i','lvl':'8'},{'word':'色々','reading':'いろいろ','eng':'various; all kinds of','adj':'na','lvl':'8'},{'word':'暗い','reading':'くらい','eng':'dark; gloomy','adj':'i','lvl':'9'},{'word':'大丈夫','reading':'だいじょうぶ','eng':'OK; all right; fine','adj':'na','lvl':'9'},{'word':'ゆっくり','reading':'','eng':'slowly; take your time','adj':'na','lvl':'9'},{'word':'速い','reading':'はやい','eng':'fast; quick','adj':'i','lvl':'11'},{'word':'若い','reading':'わかい','eng':'young','adj':'i','lvl':'11'},{'word':'かっこいい','reading':'','eng':'cool, stylish','adj':'i','lvl':'11'},{'word':'甘い','reading':'あまい','eng':'sweet','adj':'i','lvl':'11'},{'word':'派手','reading':'はで','eng':'showy; flashy','adj':'na','lvl':'11'},{'word':'地味','reading':'じみ','eng':'plain; modest','adj':'na','lvl':'11'},{'word':'分かりやすい','reading':'わかりやすい','eng':'easy to understand','adj':'i','lvl':'11'},{'word':'危ない','reading':'あぶない','eng':'dangerous','adj':'i','lvl':'12'},{'word':'はずかしい','reading':'','eng':'embarrassing, shy','adj':'i','lvl':'12'},{'word':'変','reading':'へん','eng':'strange; odd','adj':'na','lvl':'12'},{'word':'せまい','reading':'','eng':'narrow','adj':'i','lvl':'12'},{'word':'優しい','reading':'やさしい','eng':'kind; gentle','adj':'i','lvl':'12'},{'word':'すてき','reading':'','eng':'wonderful, lovely','adj':'na','lvl':'12'},{'word':'美しい','reading':'うつくしい','eng':'beautiful','adj':'i','lvl':'12'},{'word':'めずらしい','reading':'','eng':'rare, unusual','adj':'i','lvl':'12'},{'word':'遠い','reading':'とおい','eng':'far; distant','adj':'i','lvl':'12'}],
  nouns:  [{'word':'寿司','reading':'すし','eng':'sushi','lvl':'0'},{'word':'鍵','reading':'かぎ','eng':'key','lvl':'0'},{'word':'傘','reading':'かさ','eng':'umbrella','lvl':'0'},{'word':'駅','reading':'えき','eng':'station','lvl':'0'},{'word':'椅子','reading':'いす','eng':'chair','lvl':'0'},{'word':'木','reading':'き','eng':'tree','lvl':'0'},{'word':'塩','reading':'しお','eng':'salt','lvl':'0'},{'word':'牛','reading':'うし','eng':'cow, cattle','lvl':'0'},{'word':'手','reading':'て','eng':'hand','lvl':'0'},{'word':'お金','reading':'おかね','eng':'money','lvl':'0'},{'word':'くつ','reading':'','eng':'shoes','lvl':'0'},{'word':'机','reading':'つくえ','eng':'desk','lvl':'0'},{'word':'魚','reading':'さかな','eng':'fish','lvl':'0'},{'word':'肉','reading':'にく','eng':'meat','lvl':'0'},{'word':'猫','reading':'ねこ','eng':'cat','lvl':'0'},{'word':'たばこ','reading':'','eng':'cigarette, tobacco','lvl':'0'},{'word':'犬','reading':'いぬ','eng':'dog','lvl':'0'},{'word':'りんご','reading':'','eng':'apple','lvl':'0'},{'word':'眼鏡','reading':'めがね','eng':'glasses','lvl':'0'},{'word':'電話','reading':'でんわ','eng':'telephone','lvl':'0'},{'word':'鉛筆','reading':'えんぴつ','eng':'pencil','lvl':'0'},{'word':'私','reading':'わたし','eng':'I, me','lvl':'0'},{'word':'車','reading':'くるま','eng':'car','lvl':'0'},{'word':'本','reading':'ほん','eng':'book','lvl':'0'},{'word':'果物','reading':'くだもの','eng':'fruit','lvl':'0'},{'word':'新聞','reading':'しんぶん','eng':'newspaper','lvl':'0'},{'word':'鞄','reading':'かばん','eng':'bag','lvl':'0'},{'word':'切手','reading':'きって','eng':'stamp','lvl':'0'},{'word':'切符','reading':'きっぷ','eng':'ticket','lvl':'0'},{'word':'雑誌','reading':'ざっし','eng':'magazine','lvl':'0'},{'word':'学生','reading':'がくせい','eng':'student','lvl':'0'},{'word':'先生','reading':'せんせい','eng':'teacher','lvl':'0'},{'word':'時計','reading':'とけい','eng':'watch, clock','lvl':'0'},{'word':'帽子','reading':'ぼうし','eng':'hat, cap','lvl':'0'},{'word':'銀行','reading':'ぎんこう','eng':'bank','lvl':'0'},{'word':'辞書','reading':'じしょ','eng':'dictionary','lvl':'0'},{'word':'電車','reading':'でんしゃ','eng':'train','lvl':'0'},{'word':'宿題','reading':'しゅくだい','eng':'homework','lvl':'0'},{'word':'今日','reading':'きょう','eng':'today','lvl':'0'},{'word':'教室','reading':'きょうしつ','eng':'classroom','lvl':'0'},{'word':'教科書','reading':'きょうかしょ','eng':'textbook','lvl':'0'},{'word':'郵便局','reading':'ゆうびんきょく','eng':'post office','lvl':'0'},{'word':'病院','reading':'びょういん','eng':'hospital','lvl':'0'},{'word':'月曜日','reading':'げつようび','eng':'Monday','lvl':'0'},{'word':'火曜日','reading':'かようび','eng':'Tuesday','lvl':'0'},{'word':'水曜日','reading':'すいようび','eng':'Wednesday','lvl':'0'},{'word':'木曜日','reading':'もくようび','eng':'Thursday','lvl':'0'},{'word':'金曜日','reading':'きんようび','eng':'Friday','lvl':'0'},{'word':'土曜日','reading':'どようび','eng':'Saturday','lvl':'0'},{'word':'日曜日','reading':'にちようび','eng':'Sunday','lvl':'0'},{'word':'私','reading':'わたし','eng':'I, me','lvl':'1'},{'word':'あなた','reading':'','eng':'you','lvl':'1'},{'word':'彼','reading':'かれ','eng':'he, him','lvl':'1'},{'word':'彼女','reading':'かのじょ','eng':'she, her','lvl':'1'},{'word':'日本人','reading':'にほんじん','eng':'Japanese person','lvl':'1'},{'word':'韓国','reading':'かんこく','eng':'South Korea','lvl':'1'},{'word':'中国','reading':'ちゅうごく','eng':'China','lvl':'1'},{'word':'イギリス','reading':'','eng':'UK, England','lvl':'1'},{'word':'フランス','reading':'','eng':'France','lvl':'1'},{'word':'アメリカ','reading':'','eng':'USA','lvl':'1'},{'word':'学生','reading':'がくせい','eng':'student','lvl':'1'},{'word':'会社員','reading':'かいしゃいん','eng':'office worker','lvl':'1'},{'word':'先生','reading':'せんせい','eng':'teacher','lvl':'1'},{'word':'医者','reading':'いしゃ','eng':'doctor','lvl':'1'},{'word':'歌手','reading':'かしゅ','eng':'singer','lvl':'1'},{'word':'警察官','reading':'けいさつかん','eng':'police officer','lvl':'1'},{'word':'(お)国','reading':'(お)くに','eng':'country, nation','lvl':'1'},{'word':'ドイツ','reading':'','eng':'Germany','lvl':'1'},{'word':'電話番号','reading':'でんわばんごう','eng':'telephone number','lvl':'2'},{'word':'果物','reading':'くだもの','eng':'fruit','lvl':'2'},{'word':'本','reading':'ほん','eng':'book','lvl':'2'},{'word':'辞書','reading':'じしょ','eng':'dictionary','lvl':'2'},{'word':'魚','reading':'さかな','eng':'fish','lvl':'2'},{'word':'鳥','reading':'とり','eng':'bird, chicken','lvl':'2'},{'word':'飛行機','reading':'ひこうき','eng':'airplane','lvl':'2'},{'word':'（お）茶','reading':'（お）ちゃ','eng':'tea','lvl':'2'},{'word':'切手','reading':'きって','eng':'stamp','lvl':'2'},{'word':'いす','reading':'','eng':'chair','lvl':'2'},{'word':'机','reading':'つくえ','eng':'desk','lvl':'2'},{'word':'傘','reading':'かさ','eng':'umbrella','lvl':'2'},{'word':'時計','reading':'とけい','eng':'watch, clock','lvl':'2'},{'word':'猫','reading':'ねこ','eng':'cat','lvl':'2'},{'word':'犬','reading':'いぬ','eng':'dog','lvl':'2'},{'word':'雑誌','reading':'ざっし','eng':'magazine','lvl':'2'},{'word':'帽子','reading':'ぼうし','eng':'hat, cap','lvl':'2'},{'word':'鍵','reading':'かぎ','eng':'key','lvl':'2'},{'word':'ペン','reading':'','eng':'pen','lvl':'2'},{'word':'えんぴつ','reading':'','eng':'pencil','lvl':'2'},{'word':'かばん','reading':'','eng':'bag','lvl':'2'},{'word':'くつ','reading':'','eng':'shoes','lvl':'2'},{'word':'りんご','reading':'','eng':'apple','lvl':'2'},{'word':'電話','reading':'でんわ','eng':'telephone','lvl':'2'},{'word':'新聞','reading':'しんぶん','eng':'newspaper','lvl':'2'},{'word':'パイナップル','reading':'','eng':'pineapple','lvl':'2'},{'word':'みかん','reading':'','eng':'mandarin orange','lvl':'2'},{'word':'バナナ','reading':'','eng':'banana','lvl':'2'},{'word':'切符','reading':'きっぷ','eng':'ticket','lvl':'2'},{'word':'テレビ','reading':'','eng':'television','lvl':'2'},{'word':'パン','reading':'','eng':'bread','lvl':'2'},{'word':'ノート','reading':'','eng':'notebook','lvl':'2'},{'word':'車','reading':'くるま','eng':'car','lvl':'2'},{'word':'指輪','reading':'ゆびわ','eng':'ring','lvl':'2'},{'word':'シャツ','reading':'','eng':'shirt','lvl':'2'},{'word':'服','reading':'ふく','eng':'clothes','lvl':'2'},{'word':'眼鏡','reading':'めがね','eng':'glasses','lvl':'2'},{'word':'パソコン','reading':'','eng':'computer','lvl':'2'},{'word':'スイス','reading':'','eng':'Switzerland','lvl':'2'},{'word':'イタリア','reading':'','eng':'Italy','lvl':'2'},{'word':'カメラ','reading':'','eng':'camera','lvl':'2'},{'word':'（お）酒','reading':'（お）さけ','eng':'alcohol, sake','lvl':'2'},{'word':'カップ','reading':'','eng':'cup','lvl':'2'},{'word':'アパート','reading':'','eng':'apartment','lvl':'3'},{'word':'うち','reading':'','eng':'home, house','lvl':'3'},{'word':'テスト','reading':'','eng':'test, exam','lvl':'3'},{'word':'髪','reading':'かみ','eng':'hair','lvl':'3'},{'word':'ケーキ','reading':'','eng':'cake','lvl':'3'},{'word':'木','reading':'き','eng':'tree','lvl':'3'},{'word':'部屋','reading':'へや','eng':'room','lvl':'3'},{'word':'公園','reading':'こうえん','eng':'park','lvl':'3'},{'word':'東京','reading':'とうきょう','eng':'Tokyo','lvl':'3'},{'word':'地下鉄','reading':'ちかてつ','eng':'subway','lvl':'3'},{'word':'（お）金','reading':'（お）かね','eng':'money','lvl':'3'},{'word':'目','reading':'め','eng':'eye','lvl':'3'},{'word':'人','reading':'ひと','eng':'person','lvl':'3'},{'word':'クラスメート','reading':'','eng':'classmate','lvl':'3'},{'word':'駅','reading':'えき','eng':'station','lvl':'3'},{'word':'隣','reading':'となり','eng':'next door','lvl':'3'},{'word':'大家さん','reading':'おおやさん','eng':'landlord','lvl':'3'},{'word':'スケジュール','reading':'','eng':'schedule','lvl':'4'},{'word':'〜時','reading':'〜じ','eng':'~ o clock','lvl':'4'},{'word':'〜分','reading':'〜ふん','eng':'~minutes','lvl':'4'},{'word':'半','reading':'はん','eng':'half','lvl':'4'},{'word':'銀行','reading':'ぎんこう','eng':'bank','lvl':'4'},{'word':'クラス','reading':'','eng':'class','lvl':'4'},{'word':'郵便局','reading':'ゆうびんきょく','eng':'post office','lvl':'4'},{'word':'レストラン','reading':'','eng':'restaurant','lvl':'4'},{'word':'コンサート','reading':'','eng':'concert','lvl':'4'},{'word':'デパート','reading':'','eng':'department store','lvl':'4'},{'word':'映画','reading':'えいが','eng':'movie, film','lvl':'4'},{'word':'学校','reading':'がっこう','eng':'school','lvl':'4'},{'word':'ソウル','reading':'','eng':'Seoul','lvl':'4'},{'word':'コンビニ','reading':'','eng':'convenience store','lvl':'4'},{'word':'カフェ','reading':'','eng':'café','lvl':'4'},{'word':'喫茶店','reading':'きっさてん','eng':'coffee shop','lvl':'4'},{'word':'病院','reading':'びょういん','eng':'hospital','lvl':'4'},{'word':'曜日','reading':'ようび','eng':'day of week','lvl':'4'},{'word':'今日','reading':'きょう','eng':'today','lvl':'4'},{'word':'パーティ','reading':'','eng':'party','lvl':'4'},{'word':'休み','reading':'やすみ','eng':'holiday, day off','lvl':'4'},{'word':'デート','reading':'','eng':'date','lvl':'4'},{'word':'旅行','reading':'りょこう','eng':'travel, trip','lvl':'4'},{'word':'誕生日','reading':'たんじょうび','eng':'birthday','lvl':'4'},{'word':'夏休み','reading':'なつやすみ','eng':'summer vacation','lvl':'4'},{'word':'〜月','reading':'〜がつ','eng':'~month','lvl':'4'},{'word':'〜日','reading':'〜にち','eng':'~day of month','lvl':'4'},{'word':'ピクニック','reading':'','eng':'picnic','lvl':'4'},{'word':'ゴールデンウィーク','reading':'','eng':'Golden Week','lvl':'4'},{'word':'毎日','reading':'まいにち','eng':'every day','lvl':'5'},{'word':'コーヒー','reading':'','eng':'coffee','lvl':'5'},{'word':'英語','reading':'えいご','eng':'English (language)','lvl':'5'},{'word':'ビデオ','reading':'','eng':'video','lvl':'5'},{'word':'てんぷら','reading':'','eng':'tempura','lvl':'5'},{'word':'夜','reading':'よる','eng':'night','lvl':'5'},{'word':'午後','reading':'ごご','eng':'PM, afternoon','lvl':'5'},{'word':'今晩','reading':'こんばん','eng':'tonight, this evening','lvl':'5'},{'word':'たばこ','reading':'','eng':'cigarette, tobacco','lvl':'5'},{'word':'スパゲティ','reading':'','eng':'spaghetti','lvl':'5'},{'word':'明日','reading':'あした','eng':'tomorrow','lvl':'5'},{'word':'晩ごはん','reading':'ばんごはん','eng':'dinner, evening meal','lvl':'5'},{'word':'新宿','reading':'しんじゅく','eng':'Shinjuku','lvl':'5'},{'word':'会社','reading':'かいしゃ','eng':'company, office','lvl':'5'},{'word':'図書館','reading':'としょかん','eng':'library','lvl':'5'},{'word':'本屋','reading':'ほんや','eng':'bookstore','lvl':'5'},{'word':'サッカー','reading':'','eng':'soccer','lvl':'5'},{'word':'中野','reading':'なかの','eng':'Nakano','lvl':'5'},{'word':'秋葉原','reading':'あきはばら','eng':'Akihabara','lvl':'5'},{'word':'上野','reading':'うえの','eng':'Ueno','lvl':'5'},{'word':'六本木','reading':'ろっぽんぎ','eng':'Roppongi','lvl':'5'},{'word':'仕事','reading':'しごと','eng':'work, job','lvl':'5'},{'word':'ステーキ','reading':'','eng':'steak','lvl':'5'},{'word':'買い物','reading':'かいもの','eng':'shopping','lvl':'5'},{'word':'花見','reading':'はなみ','eng':'flower viewing','lvl':'5'},{'word':'京都','reading':'きょうと','eng':'Kyoto','lvl':'5'},{'word':'友達','reading':'ともだち','eng':'friend','lvl':'5'},{'word':'来月','reading':'らいげつ','eng':'next month','lvl':'5'},{'word':'北海道','reading':'ほっかいどう','eng':'Hokkaido','lvl':'5'},{'word':'海','reading':'うみ','eng':'sea, ocean','lvl':'5'},{'word':'香港','reading':'ほんこん','eng':'Hong Kong','lvl':'5'},{'word':'スキー','reading':'','eng':'skiing','lvl':'5'},{'word':'絵','reading':'え','eng':'picture, painting','lvl':'5'},{'word':'（お）寺','reading':'（お）てら','eng':'temple','lvl':'5'},{'word':'昼ごはん','reading':'ひるごはん','eng':'lunch','lvl':'5'},{'word':'電車','reading':'でんしゃ','eng':'train','lvl':'5'},{'word':'歯','reading':'は','eng':'tooth, teeth','lvl':'5'},{'word':'（お）風呂','reading':'（お）ふろ','eng':'bath','lvl':'5'},{'word':'スポーツ','reading':'','eng':'sports','lvl':'5'},{'word':'さしみ','reading':'','eng':'sashimi','lvl':'5'},{'word':'寿司','reading':'すし','eng':'sushi','lvl':'5'},{'word':'ウィスキー','reading':'','eng':'whiskey','lvl':'5'},{'word':'ビール','reading':'','eng':'beer','lvl':'5'},{'word':'ドイツ語','reading':'どいつご','eng':'German (language)','lvl':'5'},{'word':'日本酒','reading':'にほんしゅ','eng':'Japanese sake','lvl':'5'},{'word':'紅茶','reading':'こうちゃ','eng':'black tea','lvl':'5'},{'word':'フランス語','reading':'フランスご','eng':'French (language)','lvl':'5'},{'word':'掃除','reading':'そうじ','eng':'cleaning, sweeping','lvl':'5'},{'word':'洗濯','reading':'せんたく','eng':'laundry, washing','lvl':'5'},{'word':'音楽','reading':'おんがく','eng':'music','lvl':'5'},{'word':'アニメ','reading':'','eng':'anime','lvl':'5'},{'word':'ドラマ','reading':'','eng':'drama, TV drama','lvl':'5'},{'word':'料理','reading':'りょうり','eng':'cooking, cuisine','lvl':'5'},{'word':'韓国語','reading':'かんこくご','eng':'Korean (language)','lvl':'5'},{'word':'ジャズ','reading':'','eng':'jazz','lvl':'5'},{'word':'クラシック','reading':'','eng':'classical music','lvl':'5'},{'word':'RPGゲーム','reading':'','eng':'RPG game','lvl':'5'},{'word':'アクションゲーム','reading':'','eng':'action game','lvl':'5'},{'word':'渋谷','reading':'しぶや','eng':'Shibuya','lvl':'5'},{'word':'朝ごはん','reading':'あさごはん','eng':'breakfast','lvl':'5'},{'word':'パン屋','reading':'ぱんや','eng':'bakery','lvl':'5'},{'word':'アルバイト','reading':'','eng':'part-time job','lvl':'5'},{'word':'手紙','reading':'てがみ','eng':'letter (written)','lvl':'5'},{'word':'宿題','reading':'しゅくだい','eng':'homework','lvl':'5'},{'word':'一緒','reading':'いっしょ','eng':'together','lvl':'5'},{'word':'〜頃','reading':'〜ごろ','eng':'around ~ (time)','lvl':'5'},{'word':'昨日','reading':'きのう','eng':'yesterday','lvl':'6'},{'word':'昨夜','reading':'さくや','eng':'last night (formal)','lvl':'6'},{'word':'サラダ','reading':'','eng':'salad','lvl':'6'},{'word':'外国人','reading':'がいこくじん','eng':'foreigner','lvl':'6'},{'word':'銀座','reading':'ぎんざ','eng':'Ginza','lvl':'6'},{'word':'山','reading':'やま','eng':'mountain','lvl':'6'},{'word':'海','reading':'うみ','eng':'sea, ocean','lvl':'6'},{'word':'キャンプ','reading':'','eng':'camping','lvl':'6'},{'word':'おととい','reading':'','eng':'day before yesterday','lvl':'6'},{'word':'あさって','reading':'','eng':'day after tomorrow','lvl':'6'},{'word':'今週','reading':'こんしゅう','eng':'this week','lvl':'6'},{'word':'先週','reading':'せんしゅう','eng':'last week','lvl':'6'},{'word':'来週','reading':'らいしゅう','eng':'next week','lvl':'6'},{'word':'先月','reading':'せんげつ','eng':'last month','lvl':'6'},{'word':'今月','reading':'こんげつ','eng':'this month','lvl':'6'},{'word':'来月','reading':'らいげつ','eng':'next month','lvl':'6'},{'word':'去年','reading':'きょねん','eng':'last year','lvl':'6'},{'word':'今年','reading':'ことし','eng':'this year','lvl':'6'},{'word':'来年','reading':'らいねん','eng':'next year','lvl':'6'},{'word':'季節','reading':'きせつ','eng':'season','lvl':'6'},{'word':'春','reading':'はる','eng':'spring','lvl':'6'},{'word':'夏','reading':'なつ','eng':'summer','lvl':'6'},{'word':'秋','reading':'あき','eng':'autumn, fall','lvl':'6'},{'word':'冬','reading':'ふゆ','eng':'winter','lvl':'6'},{'word':'夕べ','reading':'ゆうべ','eng':'last night','lvl':'6'},{'word':'今朝','reading':'けさ','eng':'this morning','lvl':'6'},{'word':'天気','reading':'てんき','eng':'weather','lvl':'6'},{'word':'フランス料理','reading':'フランスりょうり','eng':'French cuisine','lvl':'6'},{'word':'歌','reading':'うた','eng':'song','lvl':'6'},{'word':'桜','reading':'さくら','eng':'cherry blossom','lvl':'6'},{'word':'食べ物','reading':'たべもの','eng':'food','lvl':'6'},{'word':'チケット','reading':'','eng':'ticket','lvl':'6'},{'word':'サンドイッチ','reading':'','eng':'sandwich','lvl':'6'},{'word':'旅館','reading':'りょかん','eng':'Japanese inn','lvl':'6'},{'word':'ホテル','reading':'','eng':'hotel','lvl':'6'},{'word':'お土産','reading':'おみやげ','eng':'souvenir','lvl':'6'},{'word':'おまんじゅう','reading':'','eng':'sweet bun','lvl':'6'},{'word':'花','reading':'はな','eng':'flower','lvl':'7'},{'word':'テーブル','reading':'','eng':'table','lvl':'7'},{'word':'本だな','reading':'ほんだな','eng':'bookshelf','lvl':'7'},{'word':'庭','reading':'にわ','eng':'garden, yard','lvl':'7'},{'word':'れいぞうこ','reading':'','eng':'refrigerator','lvl':'7'},{'word':'チーズ','reading':'','eng':'cheese','lvl':'7'},{'word':'ポケット','reading':'','eng':'pocket','lvl':'7'},{'word':'トマト','reading':'','eng':'tomato','lvl':'7'},{'word':'台所','reading':'だいどころ','eng':'kitchen','lvl':'7'},{'word':'居間','reading':'いま','eng':'living room','lvl':'7'},{'word':'子ども部屋','reading':'こどもべや','eng':'children\'s room','lvl':'7'},{'word':'トイレ','reading':'','eng':'toilet, bathroom','lvl':'7'},{'word':'お母さん','reading':'おかあさん','eng':'mother (someone else\'s)','lvl':'7'},{'word':'ゴキブリ','reading':'','eng':'cockroach','lvl':'7'},{'word':'たまご','reading':'','eng':'egg','lvl':'7'},{'word':'ネズミ','reading':'','eng':'mouse, rat','lvl':'7'},{'word':'ソファー','reading':'','eng':'sofa','lvl':'7'},{'word':'金庫','reading':'きんこ','eng':'safe, vault','lvl':'7'},{'word':'どろぼう','reading':'','eng':'thief, burglar','lvl':'7'},{'word':'ベッド','reading':'','eng':'bed','lvl':'7'},{'word':'子ども','reading':'こども','eng':'child, children','lvl':'7'},{'word':'おもちゃ','reading':'','eng':'toy','lvl':'7'},{'word':'スリッパ','reading':'','eng':'slippers','lvl':'7'},{'word':'タオル','reading':'','eng':'towel','lvl':'7'},{'word':'自転車','reading':'じてんしゃ','eng':'bicycle','lvl':'7'},{'word':'池','reading':'いけ','eng':'pond','lvl':'7'},{'word':'蛙','reading':'かえる','eng':'frog','lvl':'7'},{'word':'ケーキ','reading':'','eng':'cake','lvl':'7'},{'word':'ハンバーガー','reading':'','eng':'hamburger','lvl':'7'},{'word':'ジュース','reading':'','eng':'juice','lvl':'7'},{'word':'オレンジジュース','reading':'','eng':'orange juice','lvl':'7'},{'word':'男','reading':'おとこ','eng':'man, male','lvl':'7'},{'word':'女','reading':'おんな','eng':'woman, female','lvl':'7'},{'word':'コーラ','reading':'','eng':'cola','lvl':'7'},{'word':'全部','reading':'ぜんぶ','eng':'all, everything','lvl':'7'},{'word':'円','reading':'えん','eng':'yen','lvl':'7'},{'word':'おつり','reading':'','eng':'change (money)','lvl':'7'},{'word':'ファーストフード','reading':'','eng':'fast food','lvl':'7'},{'word':'ケーキ屋','reading':'ケーキや','eng':'cake shop','lvl':'7'},{'word':'箱','reading':'はこ','eng':'box','lvl':'7'},{'word':'上','reading':'うえ','eng':'above, on top','lvl':'7'},{'word':'下','reading':'した','eng':'below, under','lvl':'7'},{'word':'中','reading':'なか','eng':'inside, middle','lvl':'7'},{'word':'横','reading':'よこ','eng':'beside, next to','lvl':'7'},{'word':'ここ','reading':'','eng':'here','lvl':'7'},{'word':'そこ','reading':'','eng':'there','lvl':'7'},{'word':'あそこ','reading':'','eng':'over there','lvl':'7'},{'word':'前','reading':'まえ','eng':'in front, before','lvl':'7'},{'word':'後ろ','reading':'うしろ','eng':'behind, back','lvl':'7'},{'word':'となり','reading':'','eng':'next door','lvl':'7'},{'word':'ごみ','reading':'','eng':'garbage, trash','lvl':'7'},{'word':'ごみばこ','reading':'','eng':'trash can','lvl':'7'},{'word':'空','reading':'そら','eng':'sky','lvl':'7'},{'word':'さいふ','reading':'','eng':'wallet, purse','lvl':'7'},{'word':'駐車場','reading':'ちゅうしゃじょう','eng':'parking lot','lvl':'7'},{'word':'蕎麦屋','reading':'そばや','eng':'soba restaurant','lvl':'7'},{'word':'そば','reading':'','eng':'near, beside, soba noodles','lvl':'7'},{'word':'地図','reading':'ちず','eng':'map','lvl':'7'},{'word':'本州','reading':'ほんしゅう','eng':'Honshu','lvl':'7'},{'word':'四国','reading':'しこく','eng':'Shikoku','lvl':'7'},{'word':'九州','reading':'きゅうしゅう','eng':'Kyushu','lvl':'7'},{'word':'右','reading':'みぎ','eng':'right','lvl':'7'},{'word':'左','reading':'ひだり','eng':'left','lvl':'7'},{'word':'北','reading':'きた','eng':'north','lvl':'7'},{'word':'南','reading':'みなみ','eng':'south','lvl':'7'},{'word':'西','reading':'にし','eng':'west','lvl':'7'},{'word':'東','reading':'ひがし','eng':'east','lvl':'7'},{'word':'スキー場','reading':'スキーじょう','eng':'ski resort','lvl':'7'},{'word':'ビル','reading':'','eng':'building','lvl':'7'},{'word':'神社','reading':'じんじゃ','eng':'shrine','lvl':'7'},{'word':'観光客','reading':'かんこうきゃく','eng':'tourist','lvl':'7'},{'word':'火山','reading':'かざん','eng':'volcano','lvl':'7'},{'word':'温泉','reading':'おんせん','eng':'hot spring','lvl':'7'},{'word':'北口','reading':'きたぐち','eng':'north exit','lvl':'7'},{'word':'南口','reading':'みなみぐち','eng':'south exit','lvl':'7'},{'word':'父','reading':'ちち','eng':'father (own)','lvl':'8'},{'word':'母','reading':'はは','eng':'mother (own)','lvl':'8'},{'word':'妹','reading':'いもうと','eng':'younger sister','lvl':'8'},{'word':'象','reading':'ぞう','eng':'elephant','lvl':'8'},{'word':'きりん','reading':'','eng':'giraffe','lvl':'8'},{'word':'鼻','reading':'はな','eng':'nose','lvl':'8'},{'word':'首','reading':'くび','eng':'neck','lvl':'8'},{'word':'足','reading':'あし','eng':'leg, foot','lvl':'8'},{'word':'発音','reading':'はつおん','eng':'pronunciation','lvl':'8'},{'word':'心','reading':'こころ','eng':'heart, mind','lvl':'8'},{'word':'耳','reading':'みみ','eng':'ear','lvl':'8'},{'word':'サービス','reading':'','eng':'service','lvl':'8'},{'word':'物価','reading':'ぶっか','eng':'prices, cost of living','lvl':'8'},{'word':'家賃','reading':'やちん','eng':'rent','lvl':'8'},{'word':'うさぎ','reading':'','eng':'rabbit','lvl':'8'},{'word':'背','reading':'せ','eng':'height, stature','lvl':'8'},{'word':'国','reading':'くに','eng':'country, nation','lvl':'8'},{'word':'窓','reading':'まど','eng':'window','lvl':'8'},{'word':'店員','reading':'てんいん','eng':'shop staff','lvl':'8'},{'word':'数学','reading':'すうがく','eng':'mathematics','lvl':'8'},{'word':'甘い物','reading':'あまいもの','eng':'sweets, sweet things','lvl':'8'},{'word':'ふとん','reading':'','eng':'futon','lvl':'8'},{'word':'洋食','reading':'ようしょく','eng':'Western food','lvl':'8'},{'word':'和食','reading':'わしょく','eng':'Japanese food','lvl':'8'},{'word':'都会','reading':'とかい','eng':'city, urban area','lvl':'8'},{'word':'田舎','reading':'いなか','eng':'countryside, rural area','lvl':'8'},{'word':'肉','reading':'にく','eng':'meat','lvl':'8'},{'word':'〜タイプ','reading':'','eng':'~type','lvl':'8'},{'word':'猿','reading':'さる','eng':'monkey','lvl':'8'},{'word':'ライオン','reading':'','eng':'lion','lvl':'8'},{'word':'セーター','reading':'','eng':'sweater','lvl':'8'},{'word':'〜才','reading':'〜さい','eng':'~years old','lvl':'8'},{'word':'タクシー','reading':'','eng':'taxi','lvl':'8'},{'word':'バス','reading':'','eng':'bus','lvl':'8'},{'word':'アイスクリーム','reading':'','eng':'ice cream','lvl':'8'},{'word':'洋服','reading':'ようふく','eng':'Western clothes','lvl':'8'},{'word':'一人','reading':'ひとり','eng':'one person, alone','lvl':'8'},{'word':'漢字','reading':'かんじ','eng':'kanji','lvl':'8'},{'word':'ピアノ','reading':'','eng':'piano','lvl':'8'},{'word':'釣り','reading':'つり','eng':'fishing','lvl':'8'},{'word':'写真','reading':'しゃしん','eng':'photo, photograph','lvl':'8'},{'word':'アプリ','reading':'','eng':'app','lvl':'8'},{'word':'コート','reading':'','eng':'coat','lvl':'8'},{'word':'自己紹介','reading':'じこしょうかい','eng':'self-introduction','lvl':'8'},{'word':'趣味','reading':'しゅみ','eng':'hobby','lvl':'8'},{'word':'所','reading':'ところ','eng':'place','lvl':'8'},{'word':'家族','reading':'かぞく','eng':'family','lvl':'8'},{'word':'スポーツマン','reading':'','eng':'sportsman','lvl':'8'},{'word':'高校生','reading':'こうこうせい','eng':'high school student','lvl':'8'},{'word':'消しゴム','reading':'けしゴム','eng':'eraser','lvl':'9'},{'word':'ラジオ','reading':'','eng':'radio','lvl':'9'},{'word':'エアコン','reading':'','eng':'air conditioner','lvl':'9'},{'word':'電気','reading':'でんき','eng':'electricity, light','lvl':'9'},{'word':'引っ越し','reading':'ひっこし','eng':'moving (house)','lvl':'9'},{'word':'塩','reading':'しお','eng':'salt','lvl':'9'},{'word':'カメラマン','reading':'','eng':'photographer','lvl':'9'},{'word':'モデル','reading':'','eng':'model','lvl':'9'},{'word':'散歩','reading':'さんぽ','eng':'walk, stroll','lvl':'9'},{'word':'ロビー','reading':'','eng':'lobby','lvl':'9'},{'word':'ギター','reading':'','eng':'guitar','lvl':'9'},{'word':'（お）宅','reading':'（お）たく','eng':'your home (polite)','lvl':'9'},{'word':'熱','reading':'ねつ','eng':'fever','lvl':'10'},{'word':'薬','reading':'くすり','eng':'medicine','lvl':'10'},{'word':'美術館','reading':'びじゅつかん','eng':'art museum','lvl':'10'},{'word':'川','reading':'かわ','eng':'river','lvl':'10'},{'word':'カンニング','reading':'','eng':'cheating (on exam)','lvl':'10'},{'word':'ルール','reading':'','eng':'rule','lvl':'10'},{'word':'ゴミ','reading':'','eng':'garbage, trash','lvl':'10'},{'word':'ペット','reading':'','eng':'pet','lvl':'10'},{'word':'顔','reading':'かお','eng':'face','lvl':'10'},{'word':'掃除','reading':'そうじ','eng':'cleaning, sweeping','lvl':'10'},{'word':'洗濯','reading':'せんたく','eng':'laundry, washing','lvl':'10'},{'word':'今朝','reading':'けさ','eng':'this morning','lvl':'10'},{'word':'ジョギング','reading':'','eng':'jogging','lvl':'10'},{'word':'ハム','reading':'','eng':'ham','lvl':'10'},{'word':'牛乳','reading':'ぎゅうにゅう','eng':'milk','lvl':'10'},{'word':'恋人','reading':'こいびと','eng':'lover, partner','lvl':'10'},{'word':'シャワー','reading':'','eng':'shower','lvl':'10'},{'word':'歯','reading':'は','eng':'tooth, teeth','lvl':'10'},{'word':'食事','reading':'しょくじ','eng':'meal','lvl':'10'},{'word':'雨','reading':'あめ','eng':'rain','lvl':'10'},{'word':'ミルク','reading':'','eng':'milk','lvl':'10'},{'word':'無人島','reading':'むじんとう','eng':'deserted island','lvl':'10'},{'word':'水着','reading':'みずぎ','eng':'swimsuit','lvl':'10'},{'word':'文房具屋','reading':'ぶんぼうぐや','eng':'stationery shop','lvl':'10'},{'word':'薬屋','reading':'くすりや','eng':'pharmacy, drug store','lvl':'10'},{'word':'目薬','reading':'めぐすり','eng':'eye drops','lvl':'10'},{'word':'おにぎり','reading':'','eng':'rice ball','lvl':'10'},{'word':'飲み物','reading':'のみもの','eng':'drink, beverage','lvl':'10'},{'word':'ボールペン','reading':'','eng':'ballpoint pen','lvl':'10'},{'word':'テスト中','reading':'テストちゅう','eng':'during the exam','lvl':'10'},{'word':'牛肉','reading':'ぎゅうにく','eng':'beef','lvl':'11'},{'word':'ぶた肉','reading':'ぶたにく','eng':'pork','lvl':'11'},{'word':'人口','reading':'じんこう','eng':'population','lvl':'11'},{'word':'店','reading':'みせ','eng':'shop, store','lvl':'11'},{'word':'読書','reading':'どくしょ','eng':'reading (books)','lvl':'11'},{'word':'歴史','reading':'れきし','eng':'history','lvl':'11'},{'word':'洋酒','reading':'ようしゅ','eng':'Western liquor','lvl':'11'},{'word':'給料','reading':'きゅうりょう','eng':'salary','lvl':'11'},{'word':'身長','reading':'しんちょう','eng':'height (body)','lvl':'11'},{'word':'体重','reading':'たいじゅう','eng':'body weight','lvl':'11'},{'word':'年齢','reading':'ねんれい','eng':'age','lvl':'11'},{'word':'駅前','reading':'えきまえ','eng':'in front of the station','lvl':'11'},{'word':'デザイン','reading':'','eng':'design','lvl':'11'},{'word':'色','reading':'いろ','eng':'color','lvl':'11'},{'word':'牛丼','reading':'ぎゅうどん','eng':'beef bowl','lvl':'11'},{'word':'うどん','reading':'','eng':'udon noodles','lvl':'11'},{'word':'空気','reading':'くうき','eng':'air','lvl':'11'},{'word':'美容院','reading':'びよういん','eng':'beauty salon, hair salon','lvl':'11'},{'word':'相撲','reading':'すもう','eng':'sumo wrestling','lvl':'11'},{'word':'砂糖','reading':'さとう','eng':'sugar','lvl':'11'},{'word':'初め','reading':'はじめ','eng':'beginning, first time','lvl':'11'},{'word':'最近','reading':'さいきん','eng':'recently, lately','lvl':'11'},{'word':'街 / 町','reading':'まち','eng':'town, city, street','lvl':'11'},{'word':'すきやき','reading':'','eng':'sukiyaki','lvl':'11'},{'word':'野球','reading':'やきゅう','eng':'baseball','lvl':'11'},{'word':'スカート','reading':'','eng':'skirt','lvl':'11'},{'word':'ズボン','reading':'','eng':'trousers, pants','lvl':'11'},{'word':'不動産屋','reading':'ふどうさんや','eng':'real estate agency','lvl':'11'},{'word':'二日よい','reading':'ふつかよい','eng':'hangover','lvl':'11'},{'word':'字','reading':'じ','eng':'character, handwriting','lvl':'11'},{'word':'説明','reading':'せつめい','eng':'explanation','lvl':'11'},{'word':'ファイル','reading':'','eng':'file','lvl':'11'},{'word':'プリントアウト','reading':'','eng':'printout','lvl':'11'},{'word':'デジカメ','reading':'','eng':'digital camera','lvl':'11'},{'word':'マニュアル','reading':'','eng':'manual','lvl':'11'},{'word':'セットアップ','reading':'','eng':'setup','lvl':'11'},{'word':'靴屋','reading':'くつや','eng':'shoe store','lvl':'11'},{'word':'いくら','reading':'','eng':'how much','lvl':'11'},{'word':'席','reading':'せき','eng':'seat','lvl':'11'},{'word':'カラオケ','reading':'','eng':'karaoke','lvl':'11'},{'word':'歌舞伎','reading':'かぶき','eng':'kabuki','lvl':'11'},{'word':'お菓子','reading':'おかし','eng':'snacks, sweets','lvl':'12'},{'word':'芝生','reading':'しばふ','eng':'lawn, grass','lvl':'12'},{'word':'ダイエット','reading':'','eng':'diet','lvl':'12'},{'word':'電話代','reading':'でんわだい','eng':'phone bill','lvl':'12'},{'word':'授業中','reading':'じゅぎょうちゅう','eng':'during class','lvl':'12'},{'word':'作文','reading':'さくぶん','eng':'essay, composition','lvl':'12'},{'word':'キッチン','reading':'','eng':'kitchen','lvl':'12'},{'word':'台風','reading':'たいふう','eng':'typhoon','lvl':'12'},{'word':'美人','reading':'びじん','eng':'beautiful woman','lvl':'12'},{'word':'金持ち','reading':'かねもち','eng':'rich person','lvl':'12'},{'word':'しょうゆ','reading':'','eng':'soy sauce','lvl':'12'},{'word':'ヘルシー','reading':'','eng':'healthy','lvl':'12'},{'word':'サッカー選手','reading':'さっかーせんしゅ','eng':'soccer player','lvl':'12'},{'word':'石けん','reading':'せっけん','eng':'soap','lvl':'12'},{'word':'人気','reading':'にんき','eng':'popularity','lvl':'12'},{'word':'体','reading':'からだ','eng':'body','lvl':'12'},{'word':'品物','reading':'しなもの','eng':'goods, items','lvl':'12'},{'word':'自然','reading':'しぜん','eng':'nature','lvl':'12'},{'word':'一日中','reading':'いちにちじゅう','eng':'all day long','lvl':'12'},{'word':'残業','reading':'ざんぎょう','eng':'overtime work','lvl':'12'},{'word':'生活','reading':'せいかつ','eng':'daily life, lifestyle','lvl':'12'},{'word':'文法','reading':'ぶんぽう','eng':'grammar','lvl':'12'},{'word':'ストーリー','reading':'','eng':'story','lvl':'12'},{'word':'電車代','reading':'でんしゃだい','eng':'train fare','lvl':'12'},{'word':'方','reading':'かた','eng':'person (polite), way of doing','lvl':'12'},{'word':'外国','reading':'がいこく','eng':'foreign country','lvl':'12'},{'word':'おじいさん','reading':'','eng':'grandfather, old man','lvl':'12'},{'word':'教室','reading':'きょうしつ','eng':'classroom','lvl':'12'},{'word':'きゅうり','reading':'','eng':'cucumber','lvl':'12'},{'word':'ぶどう','reading':'','eng':'grapes','lvl':'12'}],
  kanji:  [{'kanji':'一','reading':'いち','meaning':'one','mode':'write','kl':'KL1'},{'kanji':'一つ','reading':'ひとつ','meaning':'one (counter)','mode':'write','kl':'KL1'},{'kanji':'一月','reading':'いちがつ','meaning':'January','mode':'read','kl':'KL1'},{'kanji':'二','reading':'に','meaning':'two','mode':'write','kl':'KL1'},{'kanji':'二つ','reading':'ふたつ','meaning':'two (counter)','mode':'write','kl':'KL1'},{'kanji':'二月','reading':'にがつ','meaning':'February','mode':'read','kl':'KL1'},{'kanji':'三','reading':'さん','meaning':'three','mode':'write','kl':'KL1'},{'kanji':'三つ','reading':'みっつ','meaning':'three (counter)','mode':'write','kl':'KL1'},{'kanji':'三月','reading':'さんがつ','meaning':'March','mode':'read','kl':'KL1'},{'kanji':'四','reading':'よん','meaning':'four','mode':'write','kl':'KL1'},{'kanji':'四つ','reading':'よっつ','meaning':'four (counter)','mode':'write','kl':'KL1'},{'kanji':'四月','reading':'しがつ','meaning':'April','mode':'read','kl':'KL1'},{'kanji':'五','reading':'ご','meaning':'five','mode':'write','kl':'KL1'},{'kanji':'五つ','reading':'いつつ','meaning':'five (counter)','mode':'write','kl':'KL1'},{'kanji':'五月','reading':'ごがつ','meaning':'May','mode':'read','kl':'KL1'},{'kanji':'六','reading':'ろく','meaning':'six','mode':'write','kl':'KL1'},{'kanji':'六つ','reading':'むっつ','meaning':'six (counter)','mode':'write','kl':'KL1'},{'kanji':'六百','reading':'ろっぴゃく','meaning':'600','mode':'write','kl':'KL1'},{'kanji':'六月','reading':'ろくがつ','meaning':'June','mode':'read','kl':'KL1'},{'kanji':'七','reading':'なな','meaning':'seven','mode':'write','kl':'KL1'},{'kanji':'七つ','reading':'ななつ','meaning':'seven (counter)','mode':'write','kl':'KL1'},{'kanji':'七月','reading':'しちがつ','meaning':'July','mode':'read','kl':'KL1'},{'kanji':'八','reading':'はち','meaning':'eight','mode':'write','kl':'KL1'},{'kanji':'八つ','reading':'やっつ','meaning':'eight (counter)','mode':'write','kl':'KL1'},{'kanji':'八百','reading':'はっぴゃく','meaning':'800','mode':'write','kl':'KL1'},{'kanji':'八月','reading':'はちがつ','meaning':'August','mode':'read','kl':'KL1'},{'kanji':'九','reading':'きゅう','meaning':'nine','mode':'write','kl':'KL1'},{'kanji':'九つ','reading':'ここのつ','meaning':'nine (counter)','mode':'write','kl':'KL1'},{'kanji':'九月','reading':'くがつ','meaning':'September','mode':'read','kl':'KL1'},{'kanji':'十','reading':'じゅう','meaning':'ten','mode':'write','kl':'KL1'},{'kanji':'十月','reading':'じゅうがつ','meaning':'October','mode':'read','kl':'KL1'},{'kanji':'十一月','reading':'じゅういちがつ','meaning':'November','mode':'read','kl':'KL1'},{'kanji':'十二月','reading':'じゅうにがつ','meaning':'December','mode':'read','kl':'KL1'},{'kanji':'百','reading':'ひゃく','meaning':'hundred','mode':'write','kl':'KL1'},{'kanji':'二百','reading':'にひゃく','meaning':'200','mode':'write','kl':'KL1'},{'kanji':'三百','reading':'さんびゃく','meaning':'300','mode':'write','kl':'KL1'},{'kanji':'六百','reading':'ろっぴゃく','meaning':'600','mode':'write','kl':'KL1'},{'kanji':'八百','reading':'はっぴゃく','meaning':'800','mode':'write','kl':'KL1'},{'kanji':'千','reading':'せん','meaning':'thousand','mode':'write','kl':'KL1'},{'kanji':'二千','reading':'にせん','meaning':'2000','mode':'write','kl':'KL1'},{'kanji':'三千','reading':'さんぜん','meaning':'3000','mode':'write','kl':'KL1'},{'kanji':'八千','reading':'はっせん','meaning':'8000','mode':'write','kl':'KL1'},{'kanji':'千円','reading':'せんえん','meaning':'1000 yen','mode':'write','kl':'KL1'},{'kanji':'一万','reading':'いちまん','meaning':'10,000','mode':'write','kl':'KL1'},{'kanji':'百万','reading':'ひゃくまん','meaning':'one million','mode':'write','kl':'KL1'},{'kanji':'百円','reading':'ひゃくえん','meaning':'100 yen','mode':'write','kl':'KL1'},{'kanji':'口','reading':'くち','meaning':'mouth','mode':'write','kl':'KL1'},{'kanji':'入口','reading':'いりぐち','meaning':'entrance','mode':'read','kl':'KL1'},{'kanji':'出口','reading':'でぐち','meaning':'exit','mode':'read','kl':'KL1'},{'kanji':'目','reading':'め','meaning':'eye','mode':'write','kl':'KL1'},{'kanji':'一日','reading':'ついたち','meaning':'1st (of month)','mode':'write','kl':'KL2'},{'kanji':'二日','reading':'ふつか','meaning':'2nd','mode':'write','kl':'KL2'},{'kanji':'日曜日','reading':'にちようび','meaning':'Sunday','mode':'write','kl':'KL2'},{'kanji':'日本','reading':'にほん','meaning':'Japan','mode':'write','kl':'KL2'},{'kanji':'今日','reading':'きょう','meaning':'today','mode':'write','kl':'KL2'},{'kanji':'三日','reading':'みっか','meaning':'3rd','mode':'read','kl':'KL2'},{'kanji':'一月','reading':'いちがつ','meaning':'January','mode':'write','kl':'KL2'},{'kanji':'月曜日','reading':'げつようび','meaning':'Monday','mode':'write','kl':'KL2'},{'kanji':'今月','reading':'こんげつ','meaning':'this month','mode':'write','kl':'KL2'},{'kanji':'月','reading':'つき','meaning':'moon, month','mode':'write','kl':'KL2'},{'kanji':'一か月','reading':'いっかげつ','meaning':'one month','mode':'read','kl':'KL2'},{'kanji':'火曜日','reading':'かようび','meaning':'Tuesday','mode':'write','kl':'KL2'},{'kanji':'火','reading':'ひ','meaning':'fire, Tuesday','mode':'write','kl':'KL2'},{'kanji':'水曜日','reading':'すいようび','meaning':'Wednesday','mode':'write','kl':'KL2'},{'kanji':'水','reading':'みず','meaning':'water, Wednesday','mode':'write','kl':'KL2'},{'kanji':'木曜日','reading':'もくようび','meaning':'Thursday','mode':'write','kl':'KL2'},{'kanji':'木','reading':'き','meaning':'tree','mode':'write','kl':'KL2'},{'kanji':'金曜日','reading':'きんようび','meaning':'Friday','mode':'write','kl':'KL2'},{'kanji':'お金','reading':'おかね','meaning':'money','mode':'write','kl':'KL2'},{'kanji':'土曜日','reading':'どようび','meaning':'Saturday','mode':'write','kl':'KL2'},{'kanji':'土','reading':'つち','meaning':'earth, Saturday','mode':'read','kl':'KL2'},{'kanji':'曜日','reading':'ようび','meaning':'day of week','mode':'write','kl':'KL2'},{'kanji':'本','reading':'ほん','meaning':'book, origin','mode':'write','kl':'KL2'},{'kanji':'日本','reading':'にほん','meaning':'Japan','mode':'write','kl':'KL2'},{'kanji':'一本','reading':'いっぽん','meaning':'1 (long thing)','mode':'write','kl':'KL2'},{'kanji':'二本','reading':'にほん','meaning':'2','mode':'write','kl':'KL2'},{'kanji':'三本','reading':'さんぼん','meaning':'3','mode':'write','kl':'KL2'},{'kanji':'山本さん','reading':'やまもとさん','meaning':'Yamamoto (name)','mode':'read','kl':'KL2'},{'kanji':'人','reading':'ひと','meaning':'person','mode':'write','kl':'KL2'},{'kanji':'日本人','reading':'にほんじん','meaning':'Japanese person','mode':'write','kl':'KL2'},{'kanji':'一人','reading':'ひとり','meaning':'one person, alone','mode':'write','kl':'KL2'},{'kanji':'二人','reading':'ふたり','meaning':'two people','mode':'write','kl':'KL2'},{'kanji':'三人','reading':'さんにん','meaning':'three people','mode':'write','kl':'KL2'},{'kanji':'大人','reading':'おとな','meaning':'adult','mode':'read','kl':'KL2'},{'kanji':'今','reading':'いま','meaning':'now','mode':'write','kl':'KL2'},{'kanji':'今月','reading':'こんげつ','meaning':'this month','mode':'write','kl':'KL2'},{'kanji':'今日','reading':'きょう','meaning':'today','mode':'write','kl':'KL2'},{'kanji':'（お）寺','reading':'おてら','meaning':'temple','mode':'write','kl':'KL2'},{'kanji':'一時','reading':'いちじ','meaning':'1 o\'clock','mode':'write','kl':'KL2'},{'kanji':'時々','reading':'ときどき','meaning':'sometimes','mode':'read','kl':'KL2'},{'kanji':'三時半','reading':'さんじはん','meaning':'3:30','mode':'write','kl':'KL2'},{'kanji':'半分','reading':'はんぶん','meaning':'half','mode':'write','kl':'KL2'},{'kanji':'刀','reading':'かたな','meaning':'sword, katana','mode':'read','kl':'KL2'},{'kanji':'五分','reading':'ごふん','meaning':'5 minutes','mode':'write','kl':'KL2'},{'kanji':'十分','reading':'じゅっぷん','meaning':'10 minutes','mode':'write','kl':'KL2'},{'kanji':'半分','reading':'はんぶん','meaning':'half','mode':'write','kl':'KL2'},{'kanji':'分かる','reading':'わかる','meaning':'to understand','mode':'write','kl':'KL2'},{'kanji':'上','reading':'うえ','meaning':'above, up','mode':'write','kl':'KL3'},{'kanji':'上げる','reading':'あげる','meaning':'to raise, to give','mode':'write','kl':'KL3'},{'kanji':'下','reading':'した','meaning':'below, down','mode':'write','kl':'KL3'},{'kanji':'下げる','reading':'さげる','meaning':'to lower','mode':'write','kl':'KL3'},{'kanji':'下さい','reading':'ください','meaning':'please give me','mode':'read','kl':'KL3'},{'kanji':'上下','reading':'じょうげ','meaning':'up and down','mode':'read','kl':'KL3'},{'kanji':'中','reading':'なか','meaning':'inside, middle','mode':'write','kl':'KL3'},{'kanji':'中国','reading':'ちゅうごく','meaning':'China','mode':'read','kl':'KL3'},{'kanji':'一年中','reading':'いちねんじゅう','meaning':'all year long','mode':'read','kl':'KL3'},{'kanji':'一日中','reading':'いちにちじゅう','meaning':'all day long','mode':'read','kl':'KL3'},{'kanji':'外','reading':'そと','meaning':'outside','mode':'write','kl':'KL3'},{'kanji':'外国','reading':'がいこく','meaning':'foreign country','mode':'read','kl':'KL3'},{'kanji':'外国人','reading':'がいこくじん','meaning':'foreigner','mode':'read','kl':'KL3'},{'kanji':'右','reading':'みぎ','meaning':'right','mode':'write','kl':'KL3'},{'kanji':'右側','reading':'みぎがわ','meaning':'right side','mode':'read','kl':'KL3'},{'kanji':'左右','reading':'さゆう','meaning':'left and right','mode':'read','kl':'KL3'},{'kanji':'工事中','reading':'こうじちゅう','meaning':'under construction','mode':'read','kl':'KL3'},{'kanji':'左','reading':'ひだり','meaning':'left','mode':'write','kl':'KL3'},{'kanji':'左側','reading':'ひだりがわ','meaning':'left side','mode':'read','kl':'KL3'},{'kanji':'前','reading':'まえ','meaning':'front, before','mode':'write','kl':'KL3'},{'kanji':'午前','reading':'ごぜん','meaning':'AM, morning','mode':'write','kl':'KL3'},{'kanji':'午前中','reading':'ごぜんちゅう','meaning':'during the morning','mode':'write','kl':'KL3'},{'kanji':'名前','reading':'なまえ','meaning':'name','mode':'read','kl':'KL3'},{'kanji':'後ろ','reading':'うしろ','meaning':'behind, back','mode':'write','kl':'KL3'},{'kanji':'クラスの後','reading':'あと','meaning':'after class','mode':'write','kl':'KL3'},{'kanji':'後で','reading':'あとで','meaning':'later','mode':'write','kl':'KL3'},{'kanji':'午後','reading':'ごご','meaning':'PM, afternoon','mode':'write','kl':'KL3'},{'kanji':'午前','reading':'ごぜん','meaning':'AM, morning','mode':'write','kl':'KL3'},{'kanji':'午前中','reading':'ごぜんちゅう','meaning':'during the morning','mode':'write','kl':'KL3'},{'kanji':'門','reading':'もん','meaning':'gate','mode':'write','kl':'KL3'},{'kanji':'間','reading':'あいだ','meaning':'between, space','mode':'write','kl':'KL3'},{'kanji':'時間','reading':'じかん','meaning':'hours','mode':'write','kl':'KL3'},{'kanji':'二時間','reading':'にじかん','meaning':'two hours','mode':'write','kl':'KL3'},{'kanji':'東','reading':'ひがし','meaning':'east','mode':'write','kl':'KL3'},{'kanji':'東口','reading':'ひがしぐち','meaning':'east exit','mode':'write','kl':'KL3'},{'kanji':'東京','reading':'とうきょう','meaning':'Tokyo','mode':'read','kl':'KL3'},{'kanji':'西','reading':'にし','meaning':'west','mode':'write','kl':'KL3'},{'kanji':'西口','reading':'にしぐち','meaning':'west exit','mode':'write','kl':'KL3'},{'kanji':'南','reading':'みなみ','meaning':'south','mode':'write','kl':'KL3'},{'kanji':'南口','reading':'みなみぐち','meaning':'south exit','mode':'write','kl':'KL3'},{'kanji':'東南アジア','reading':'とうなんアジア','meaning':'Southeast Asia','mode':'write','kl':'KL3'},{'kanji':'北','reading':'きた','meaning':'north','mode':'write','kl':'KL3'},{'kanji':'北口','reading':'きたぐち','meaning':'north exit','mode':'write','kl':'KL3'},{'kanji':'田中さん','reading':'たなかさん','meaning':'Tanaka (name)','mode':'write','kl':'KL4'},{'kanji':'山田さん','reading':'やまださん','meaning':'Yamada (name)','mode':'read','kl':'KL4'},{'kanji':'力','reading':'ちから','meaning':'power, strength','mode':'write','kl':'KL4'},{'kanji':'協力する','reading':'きょうりょくする','meaning':'to cooperate','mode':'read','kl':'KL4'},{'kanji':'男の子','reading':'おとこのこ','meaning':'boy','mode':'write','kl':'KL4'},{'kanji':'男の人','reading':'おとこのひと','meaning':'man','mode':'write','kl':'KL4'},{'kanji':'男性','reading':'だんせい','meaning':'male','mode':'read','kl':'KL4'},{'kanji':'女の子','reading':'おんなのこ','meaning':'girl','mode':'write','kl':'KL4'},{'kanji':'女の人','reading':'おんなのひと','meaning':'woman','mode':'write','kl':'KL4'},{'kanji':'女性','reading':'じょせい','meaning':'female','mode':'read','kl':'KL4'},{'kanji':'子供','reading':'こども','meaning':'child','mode':'read','kl':'KL4'},{'kanji':'学生','reading':'がくせい','meaning':'student','mode':'write','kl':'KL4'},{'kanji':'大学','reading':'だいがく','meaning':'university','mode':'read','kl':'KL4'},{'kanji':'学校','reading':'がっこう','meaning':'school','mode':'read','kl':'KL4'},{'kanji':'先生','reading':'せんせい','meaning':'teacher','mode':'write','kl':'KL4'},{'kanji':'生まれる','reading':'うまれる','meaning':'to be born','mode':'write','kl':'KL4'},{'kanji':'生きる','reading':'いきる','meaning':'to live','mode':'write','kl':'KL4'},{'kanji':'誕生日','reading':'たんじょうび','meaning':'birthday','mode':'read','kl':'KL4'},{'kanji':'先月','reading':'せんげつ','meaning':'last month','mode':'write','kl':'KL4'},{'kanji':'先に','reading':'さきに','meaning':'ahead, first','mode':'read','kl':'KL4'},{'kanji':'何','reading':'なに','meaning':'what','mode':'write','kl':'KL4'},{'kanji':'何か','reading':'なにか','meaning':'something','mode':'write','kl':'KL4'},{'kanji':'何人','reading':'なんにん','meaning':'how many people','mode':'write','kl':'KL4'},{'kanji':'何時','reading':'なんじ','meaning':'what time','mode':'write','kl':'KL4'},{'kanji':'父','reading':'ちち','meaning':'(my) father','mode':'write','kl':'KL4'},{'kanji':'お父さん','reading':'おとうさん','meaning':'father','mode':'write','kl':'KL4'},{'kanji':'母','reading':'はは','meaning':'(my) mother','mode':'write','kl':'KL4'},{'kanji':'お母さん','reading':'おかあさん','meaning':'mother (someone else\'s)','mode':'write','kl':'KL4'},{'kanji':'一年','reading':'いちねん','meaning':'one year','mode':'write','kl':'KL4'},{'kanji':'今年','reading':'ことし','meaning':'this year','mode':'write','kl':'KL4'},{'kanji':'年','reading':'とし','meaning':'year','mode':'write','kl':'KL4'},{'kanji':'去年','reading':'きょねん','meaning':'last year','mode':'write','kl':'KL4'},{'kanji':'毎日','reading':'まいにち','meaning':'every day','mode':'write','kl':'KL4'},{'kanji':'毎月','reading':'まいつき','meaning':'every month','mode':'write','kl':'KL4'},{'kanji':'毎年','reading':'まいとし','meaning':'every year','mode':'write','kl':'KL4'},{'kanji':'国王','reading':'こくおう','meaning':'king','mode':'read','kl':'KL4'},{'kanji':'国','reading':'くに','meaning':'country, nation','mode':'write','kl':'KL4'},{'kanji':'外国','reading':'がいこく','meaning':'foreign country','mode':'write','kl':'KL4'},{'kanji':'中国','reading':'ちゅうごく','meaning':'China','mode':'write','kl':'KL4'},{'kanji':'国籍','reading':'こくせき','meaning':'nationality','mode':'read','kl':'KL4'},{'kanji':'見る','reading':'みる','meaning':'to see','mode':'write','kl':'KL5'},{'kanji':'見せる','reading':'みせる','meaning':'to show','mode':'write','kl':'KL5'},{'kanji':'行く','reading':'いく','meaning':'to go','mode':'write','kl':'KL5'},{'kanji':'銀行','reading':'ぎんこう','meaning':'bank','mode':'read','kl':'KL5'},{'kanji':'旅行','reading':'りょこう','meaning':'travel','mode':'read','kl':'KL5'},{'kanji':'お米','reading':'おこめ','meaning':'rice (uncooked)','mode':'write','kl':'KL5'},{'kanji':'欧米','reading':'おうべい','meaning':'Europe and America','mode':'read','kl':'KL5'},{'kanji':'来る','reading':'くる','meaning':'to come','mode':'write','kl':'KL5'},{'kanji':'来ます','reading':'きます','meaning':'to come (polite)','mode':'write','kl':'KL5'},{'kanji':'来ない','reading':'こない','meaning':'does not come','mode':'write','kl':'KL5'},{'kanji':'来年','reading':'らいねん','meaning':'next year','mode':'write','kl':'KL5'},{'kanji':'来週','reading':'らいしゅう','meaning':'next week','mode':'write','kl':'KL5'},{'kanji':'良い','reading':'よい','meaning':'good','mode':'read','kl':'KL5'},{'kanji':'食べる','reading':'たべる','meaning':'to eat','mode':'write','kl':'KL5'},{'kanji':'食べ物','reading':'たべもの','meaning':'food','mode':'read','kl':'KL5'},{'kanji':'食事','reading':'しょくじ','meaning':'meal','mode':'read','kl':'KL5'},{'kanji':'飲む','reading':'のむ','meaning':'to drink','mode':'write','kl':'KL5'},{'kanji':'飲み物','reading':'のみもの','meaning':'drink, beverage','mode':'read','kl':'KL5'},{'kanji':'飲食店','reading':'いんしょくてん','meaning':'restaurant, eatery','mode':'read','kl':'KL5'},{'kanji':'会う','reading':'あう','meaning':'to meet','mode':'write','kl':'KL5'},{'kanji':'会話','reading':'かいわ','meaning':'conversation','mode':'write','kl':'KL5'},{'kanji':'会社','reading':'かいしゃ','meaning':'company; office','mode':'read','kl':'KL5'},{'kanji':'耳','reading':'みみ','meaning':'ear','mode':'write','kl':'KL5'},{'kanji':'聞く','reading':'きく','meaning':'to listen, hear','mode':'write','kl':'KL5'},{'kanji':'新聞','reading':'しんぶん','meaning':'newspaper','mode':'read','kl':'KL5'},{'kanji':'言う','reading':'いう','meaning':'to say','mode':'write','kl':'KL5'},{'kanji':'話す','reading':'はなす','meaning':'to speak','mode':'write','kl':'KL5'},{'kanji':'話','reading':'はなし','meaning':'story, talk','mode':'write','kl':'KL5'},{'kanji':'電話','reading':'でんわ','meaning':'telephone','mode':'read','kl':'KL5'},{'kanji':'話し合う','reading':'はなしあう','meaning':'to discuss','mode':'read','kl':'KL5'},{'kanji':'立つ','reading':'たつ','meaning':'to stand','mode':'write','kl':'KL5'},{'kanji':'国立大学','reading':'こくりつだいがく','meaning':'national university','mode':'read','kl':'KL5'},{'kanji':'待つ','reading':'まつ','meaning':'to wait','mode':'write','kl':'KL5'},{'kanji':'待ち合わせ','reading':'まちあわせ','meaning':'meeting up','mode':'read','kl':'KL5'},{'kanji':'周り','reading':'まわり','meaning':'surroundings','mode':'read','kl':'KL5'},{'kanji':'一周','reading':'いっしゅう','meaning':'1 lap','mode':'read','kl':'KL5'},{'kanji':'今週','reading':'こんしゅう','meaning':'this week','mode':'write','kl':'KL5'},{'kanji':'先週','reading':'せんしゅう','meaning':'last week','mode':'write','kl':'KL5'},{'kanji':'毎週','reading':'まいしゅう','meaning':'every week','mode':'write','kl':'KL5'},{'kanji':'一週間','reading':'いっしゅうかん','meaning':'one week','mode':'write','kl':'KL5'},{'kanji':'週末','reading':'しゅうまつ','meaning':'weekend','mode':'read','kl':'KL5'},{'kanji':'大きい','reading':'おおきい','meaning':'big','mode':'write','kl':'KL6'},{'kanji':'大学生','reading':'だいがくせい','meaning':'university student','mode':'write','kl':'KL6'},{'kanji':'大好きな','reading':'だいすきな','meaning':'like very much','mode':'write','kl':'KL6'},{'kanji':'大切な','reading':'たいせつな','meaning':'important','mode':'read','kl':'KL6'},{'kanji':'小さい','reading':'ちいさい','meaning':'small','mode':'write','kl':'KL6'},{'kanji':'小学校','reading':'しょうがっこう','meaning':'elementary school','mode':'read','kl':'KL6'},{'kanji':'高い','reading':'たかい','meaning':'tall, expensive','mode':'write','kl':'KL6'},{'kanji':'高校','reading':'こうこう','meaning':'high school','mode':'read','kl':'KL6'},{'kanji':'円高','reading':'えんだか','meaning':'strong yen','mode':'read','kl':'KL6'},{'kanji':'安い','reading':'やすい','meaning':'cheap','mode':'write','kl':'KL6'},{'kanji':'安全','reading':'あんぜん','meaning':'safe, safety','mode':'read','kl':'KL6'},{'kanji':'円安','reading':'えんやす','meaning':'weak yen','mode':'read','kl':'KL6'},{'kanji':'新しい','reading':'あたらしい','meaning':'new','mode':'write','kl':'KL6'},{'kanji':'新聞','reading':'しんぶん','meaning':'newspaper','mode':'write','kl':'KL6'},{'kanji':'古い','reading':'ふるい','meaning':'old','mode':'write','kl':'KL6'},{'kanji':'中古','reading':'ちゅうこ','meaning':'second-hand','mode':'read','kl':'KL6'},{'kanji':'元気な','reading':'げんきな','meaning':'healthy, energetic','mode':'write','kl':'KL6'},{'kanji':'気をつける','reading':'きをつける','meaning':'to be careful','mode':'write','kl':'KL6'},{'kanji':'天気','reading':'てんき','meaning':'weather','mode':'read','kl':'KL6'},{'kanji':'電気','reading':'でんき','meaning':'electricity; light (electric)','mode':'read','kl':'KL6'},{'kanji':'気持ち','reading':'きもち','meaning':'feeling; mood','mode':'read','kl':'KL6'},{'kanji':'人気','reading':'にんき','meaning':'popularity','mode':'read','kl':'KL6'},{'kanji':'多い','reading':'おおい','meaning':'many','mode':'write','kl':'KL6'},{'kanji':'少し','reading':'すこし','meaning':'a little','mode':'write','kl':'KL6'},{'kanji':'少ない','reading':'すくない','meaning':'few','mode':'write','kl':'KL6'},{'kanji':'少々','reading':'しょうしょう','meaning':'a little (formal)','mode':'read','kl':'KL6'},{'kanji':'広い','reading':'ひろい','meaning':'wide','mode':'write','kl':'KL6'},{'kanji':'早い','reading':'はやい','meaning':'fast, early','mode':'write','kl':'KL6'},{'kanji':'早く','reading':'はやく','meaning':'quickly, early','mode':'write','kl':'KL6'},{'kanji':'長い','reading':'ながい','meaning':'long','mode':'write','kl':'KL6'},{'kanji':'社長','reading':'しゃちょう','meaning':'company president','mode':'read','kl':'KL6'},{'kanji':'明るい','reading':'あかるい','meaning':'bright','mode':'write','kl':'KL6'},{'kanji':'明日','reading':'あした','meaning':'tomorrow','mode':'write','kl':'KL6'},{'kanji':'説明','reading':'せつめい','meaning':'explanation','mode':'read','kl':'KL6'},{'kanji':'好きな','reading':'すきな','meaning':'liked','mode':'write','kl':'KL6'},{'kanji':'大好きな','reading':'だいすきな','meaning':'like very much','mode':'write','kl':'KL6'},{'kanji':'友だち','reading':'ともだち','meaning':'friend','mode':'write','kl':'KL6'},{'kanji':'友人','reading':'ゆうじん','meaning':'friend (formal)','mode':'read','kl':'KL6'},{'kanji':'親友','reading':'しんゆう','meaning':'close friend','mode':'read','kl':'KL6'},{'kanji':'入る','reading':'はいる','meaning':'to enter','mode':'write','kl':'KL7'},{'kanji':'入れる','reading':'いれる','meaning':'to put in','mode':'write','kl':'KL7'},{'kanji':'入学する','reading':'にゅうがくする','meaning':'to enrol','mode':'write','kl':'KL7'},{'kanji':'出る','reading':'でる','meaning':'to leave','mode':'write','kl':'KL7'},{'kanji':'出かける','reading':'でかける','meaning':'to go out','mode':'write','kl':'KL7'},{'kanji':'出す','reading':'だす','meaning':'to take out','mode':'write','kl':'KL7'},{'kanji':'出席する','reading':'しゅっせきする','meaning':'to attend','mode':'read','kl':'KL7'},{'kanji':'つくば市','reading':'つくばし','meaning':'Tsukuba City','mode':'write','kl':'KL7'},{'kanji':'市役所','reading':'しやくしょ','meaning':'city hall','mode':'read','kl':'KL7'},{'kanji':'町','reading':'まち','meaning':'town','mode':'write','kl':'KL7'},{'kanji':'田町','reading':'たまち','meaning':'Tamachi','mode':'read','kl':'KL7'},{'kanji':'本町','reading':'ほんちょう','meaning':'Honcho','mode':'read','kl':'KL7'},{'kanji':'村','reading':'むら','meaning':'village','mode':'write','kl':'KL7'},{'kanji':'市町村','reading':'しちょうそん','meaning':'municipalities','mode':'read','kl':'KL7'},{'kanji':'雨','reading':'あめ','meaning':'rain','mode':'write','kl':'KL7'},{'kanji':'大雨','reading':'おおあめ','meaning':'heavy rain','mode':'read','kl':'KL7'},{'kanji':'電気','reading':'でんき','meaning':'electricity; light (electric)','mode':'write','kl':'KL7'},{'kanji':'電車','reading':'でんしゃ','meaning':'train','mode':'write','kl':'KL7'},{'kanji':'電話','reading':'でんわ','meaning':'telephone','mode':'write','kl':'KL7'},{'kanji':'電力','reading':'でんりょく','meaning':'electricity, power','mode':'read','kl':'KL7'},{'kanji':'電池','reading':'でんち','meaning':'battery','mode':'read','kl':'KL7'},{'kanji':'電源','reading':'でんげん','meaning':'power source','mode':'read','kl':'KL7'},{'kanji':'車','reading':'くるま','meaning':'car','mode':'write','kl':'KL7'},{'kanji':'自転車','reading':'じてんしゃ','meaning':'bicycle','mode':'read','kl':'KL7'},{'kanji':'駐車場','reading':'ちゅうしゃじょう','meaning':'parking lot','mode':'read','kl':'KL7'},{'kanji':'馬','reading':'うま','meaning':'horse','mode':'write','kl':'KL7'},{'kanji':'駅','reading':'えき','meaning':'station','mode':'write','kl':'KL7'},{'kanji':'駅員','reading':'えきいん','meaning':'station staff','mode':'read','kl':'KL7'},{'kanji':'会社','reading':'かいしゃ','meaning':'company; office','mode':'write','kl':'KL7'},{'kanji':'社会','reading':'しゃかい','meaning':'society','mode':'write','kl':'KL7'},{'kanji':'社長','reading':'しゃちょう','meaning':'company president','mode':'write','kl':'KL7'},{'kanji':'学校','reading':'がっこう','meaning':'school','mode':'write','kl':'KL7'},{'kanji':'校長','reading':'こうちょう','meaning':'school principal','mode':'write','kl':'KL7'},{'kanji':'店','reading':'みせ','meaning':'shop, store','mode':'write','kl':'KL7'},{'kanji':'店員','reading':'てんいん','meaning':'shop staff','mode':'read','kl':'KL7'},{'kanji':'売店','reading':'ばいてん','meaning':'kiosk, stand','mode':'read','kl':'KL7'},{'kanji':'店長','reading':'てんちょう','meaning':'store manager','mode':'read','kl':'KL7'},{'kanji':'銀行','reading':'ぎんこう','meaning':'bank','mode':'write','kl':'KL7'},{'kanji':'病気','reading':'びょうき','meaning':'illness, disease','mode':'write','kl':'KL7'},{'kanji':'病院','reading':'びょういん','meaning':'hospital','mode':'read','kl':'KL7'},{'kanji':'入院する','reading':'にゅういんする','meaning':'to be hospitalised','mode':'write','kl':'KL7'},{'kanji':'大学院','reading':'だいがくいん','meaning':'graduate school','mode':'write','kl':'KL7'},{'kanji':'退院する','reading':'たいいんする','meaning':'to be discharged (hospital)','mode':'read','kl':'KL7'},{'kanji':'美容院','reading':'びよういん','meaning':'beauty salon, hair salon','mode':'read','kl':'KL7'},{'kanji':'休む','reading':'やすむ','meaning':'to rest','mode':'write','kl':'KL8'},{'kanji':'休み','reading':'やすみ','meaning':'rest, holiday','mode':'write','kl':'KL8'},{'kanji':'休日','reading':'きゅうじつ','meaning':'holiday','mode':'read','kl':'KL8'},{'kanji':'定休日','reading':'ていきゅうび','meaning':'regular holiday (closed day)','mode':'read','kl':'KL8'},{'kanji':'走る','reading':'はしる','meaning':'to run','mode':'write','kl':'KL8'},{'kanji':'起きる','reading':'おきる','meaning':'to wake up','mode':'write','kl':'KL8'},{'kanji':'起こす','reading':'おこす','meaning':'to wake someone up','mode':'write','kl':'KL8'},{'kanji':'貝','reading':'かい','meaning':'shellfish','mode':'write','kl':'KL8'},{'kanji':'買う','reading':'かう','meaning':'to buy','mode':'write','kl':'KL8'},{'kanji':'買い物','reading':'かいもの','meaning':'shopping','mode':'read','kl':'KL8'},{'kanji':'売る','reading':'うる','meaning':'to sell','mode':'write','kl':'KL8'},{'kanji':'売り切れる','reading':'うりきれる','meaning':'to sell out','mode':'read','kl':'KL8'},{'kanji':'売り場','reading':'うりば','meaning':'sales floor','mode':'read','kl':'KL8'},{'kanji':'売店','reading':'ばいてん','meaning':'kiosk, stand','mode':'read','kl':'KL8'},{'kanji':'読む','reading':'よむ','meaning':'to read','mode':'write','kl':'KL8'},{'kanji':'書く','reading':'かく','meaning':'to write','mode':'write','kl':'KL8'},{'kanji':'読書','reading':'どくしょ','meaning':'reading (books)','mode':'read','kl':'KL8'},{'kanji':'図書館','reading':'としょかん','meaning':'library','mode':'read','kl':'KL8'},{'kanji':'辞書','reading':'じしょ','meaning':'dictionary','mode':'read','kl':'KL8'},{'kanji':'教科書','reading':'きょうかしょ','meaning':'textbook','mode':'read','kl':'KL8'},{'kanji':'帰る','reading':'かえる','meaning':'to return','mode':'write','kl':'KL8'},{'kanji':'帰国','reading':'きこく','meaning':'return to country','mode':'read','kl':'KL8'},{'kanji':'日帰り旅行','reading':'ひがえりりょこう','meaning':'day trip','mode':'read','kl':'KL8'},{'kanji':'弓','reading':'ゆみ','meaning':'bow (archery)','mode':'write','kl':'KL8'},{'kanji':'虫','reading':'むし','meaning':'insect, bug','mode':'write','kl':'KL8'},{'kanji':'強い','reading':'つよい','meaning':'strong','mode':'write','kl':'KL8'},{'kanji':'勉強する','reading':'べんきょうする','meaning':'to study','mode':'write','kl':'KL8'},{'kanji':'持つ','reading':'もつ','meaning':'to hold, have','mode':'write','kl':'KL8'},{'kanji':'お金持ち','reading':'おかねもち','meaning':'rich person','mode':'write','kl':'KL8'},{'kanji':'気持ち','reading':'きもち','meaning':'feeling; mood','mode':'write','kl':'KL8'},{'kanji':'持ち物','reading':'もちもの','meaning':'belongings','mode':'read','kl':'KL8'},{'kanji':'名前','reading':'なまえ','meaning':'name','mode':'write','kl':'KL8'},{'kanji':'有名な','reading':'ゆうめいな','meaning':'famous','mode':'read','kl':'KL8'},{'kanji':'氏名','reading':'しめい','meaning':'full name','mode':'read','kl':'KL8'},{'kanji':'名字','reading':'みょうじ','meaning':'surname, family name','mode':'read','kl':'KL8'},{'kanji':'名詞','reading':'めいし','meaning':'noun','mode':'read','kl':'KL8'},{'kanji':'日本語','reading':'にほんご','meaning':'Japanese','mode':'write','kl':'KL8'},{'kanji':'中国語','reading':'ちゅうごくご','meaning':'Chinese','mode':'write','kl':'KL8'},{'kanji':'英語','reading':'えいご','meaning':'English (language)','mode':'read','kl':'KL8'},{'kanji':'外国語','reading':'がいこくご','meaning':'foreign language','mode':'read','kl':'KL8'},{'kanji':'押','reading':'おす','meaning':'push (door sign · PUSH)','mode':'read','kl':'SIGN'},{'kanji':'引','reading':'ひく','meaning':'pull (door sign · PULL)','mode':'read','kl':'SIGN'},{'kanji':'開','reading':'あく / ひらく','meaning':'open (lift button · door sign)','mode':'read','kl':'SIGN'},{'kanji':'閉','reading':'しまる / しめる','meaning':'close (lift button · closed)','mode':'read','kl':'SIGN'},{'kanji':'自動','reading':'じどう','meaning':'automatic','mode':'read','kl':'SIGN'},{'kanji':'自動ドア','reading':'じどうドア','meaning':'automatic door','mode':'read','kl':'SIGN'},{'kanji':'運転','reading':'うんてん','meaning':'operation (switch label)','mode':'read','kl':'SIGN'},{'kanji':'入','reading':'いり','meaning':'ON (switch · 運転 入)','mode':'read','kl':'SIGN'},{'kanji':'切','reading':'きり','meaning':'OFF (switch · 運転 切)','mode':'read','kl':'SIGN'},{'kanji':'入口','reading':'いりぐち','meaning':'entrance','mode':'read','kl':'SIGN'},{'kanji':'出口','reading':'でぐち','meaning':'exit','mode':'read','kl':'SIGN'},{'kanji':'東','reading':'ひがし','meaning':'east','mode':'read','kl':'SIGN'},{'kanji':'西','reading':'にし','meaning':'west','mode':'read','kl':'SIGN'},{'kanji':'南','reading':'みなみ','meaning':'south','mode':'read','kl':'SIGN'},{'kanji':'北','reading':'きた','meaning':'north','mode':'read','kl':'SIGN'}],
};
const questionsData = [
...
function setTab(tab, btn){
  ...
  function applyTab(){
    ...
    setTimeout(()=>{ document.getElementById('words-floats').classList.toggle('ff-visible', tab==='words'); }, 80);
    applyFilterVisuals();
    render();
...
const LESSON_META = {
  GEN:{jp:'ウォーミングアップ', en:'General · Words to Know', hint:'WU Day 1–5 — universal words the course assumes you know'},
...
{id:'L2',title:'だい2か',en:'Lesson 2 · Numbers, これ・それ・あれ, prices',goal:'電話番号を聞くことができる／お店で買い物ができる「いくら？」「どこの商品？」— Ask a phone number; shop at a store: how much, and where it is from.',emoji:_gicon.shop,cards:[
  ...
  {label:'2-4 ｜ この・その・あの ＋ Noun',
   ...
   rows:[{jp:'このかさは 1200えんです。',en:'This umbrella is 1,200 yen.'},{jp:'Q：そのとけいは いくらですか。',en:'How much is that watch?'},{jp:'A：（これは）30000えんです。',en:'It is 30,000 yen.'}],
   note:'これ = a pronoun (stands alone). この = a modifier (always + noun). Never say ×これかさ.',
   imgs:['2-4-2.webp','2-4-3.webp','2-4-1.webp']},
  {label:'2-4 ｜ おみせの かいわ ｜ Shop conversation',
   ...
   convo:{title:'おみせで ｜ At the shop',lines:[
     ...
     ['B','ああ、それは（30000）円です。','Ah, that one is 30,000 yen.'],
...
{id:'REF3',title:'じょすうし',en:'Reference · Counters',goal:'助数詞 — which counter goes with which kind of thing, and where the sound changes are.',emoji:_gicon.count,cards:[
  ...
  {label:'こ ｜ 1個、2個 — small items',
   ...
   rows:[{jp:'いっこ・にこ・さんこ・よんこ・ごこ',en:'1–5'},{jp:'ろっこ・ななこ・はっこ（はちこ）・きゅうこ・じゅっこ',en:'6–10 ⚠ sound changes'},{jp:'Q：なんこですか。',en:'How many?'}],
  ...
  {label:'さつ ｜ 1冊、2冊 — books',
   ...
   note:'Tap any number word in the Words tab to open the full counter tables (people, minutes, hours, months, days, weeks, years and more).',
...
function renderLvlFilters(type){
  ...
  el.innerHTML=lvls.map(lvl=>{
    ...
    const lab=lvl===0?'WU':String(lvl);
    const wide=lab.length>2;
    return '<button onclick="filterSheetLvl('+lvl+',this)" title="'+(lvl===0?'Warming Up / general words':'Lesson '+lvl)+'" style="'+(wide?'padding:0 9px;border-radius:14px;':'width:28px;border-radius:50%;padding:0;')+'height:28px;border:1.5px solid '+(a?'var(--red)':'var(--dot)')+';background:'+(a?'var(--red)':'var(--white)')+';color:'+(a?'var(--white)':'var(--mid)')+';font-size:10px;font-weight:700;cursor:pointer;font-family:Arial,sans-serif;">'+lab+'</button>';
  }).join('');
}
...
function _lvlLabel(l){ return String(l)==='0' ? 'WU' : 'L'+l; }
